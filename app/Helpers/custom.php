...
define('ORDER_TYPE',[
    '1' => '<span class="label label-primary label-pill label-inline" style="min-width:70px !important;">Office</span>',
    '2' => '<span class="label label-success label-pill label-inline" style="min-width:70px !important;">Dealer</span>',
]) ;
define('SALE_STATUS',[
    '1' => '<span class="label label-primary label-pill label-inline" style="min-width:70px !important;">Pending</span>',
    '2' => '<span class="label label-success label-pill label-inline" style="min-width:70px !important;">Approve</span>',
...
define('PURCHASE_STATUS',['1'=>'Received','2'=>'Rejected','3'=>'Pending','4'=>'Ordered']);
define('PURCHASE_STATUS_LABEL',[
    ...
    '2'=>'<span class="label label-warning label-pill label-inline" style="min-width:70px !important;">Rejected</span>',
