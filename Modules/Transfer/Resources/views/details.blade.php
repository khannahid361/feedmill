            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('transfer.inventory') }}" class="btn btn-warning btn-sm font-weight-bolder"><i
                                ...
                                <div>
                                            ...
                                            <td width="50%">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td><b>: </b>{{ $transfer->challan_no }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Transfer Date</b></td>
                                                        <td><b>: </b>{{ date('d-M-Y', strtotime($transfer->transfer_date)) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Transfer Status</b></td>
                                                        <td><b>:
                                                            </b>{{ $transfer->transfer_status == 1 ? 'Transferred' : 'Pending' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Driver Name</b></td>
                                                        <td><b>: </b>{{ $transfer->driver_name }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>From</b></td>
                                                        <td><b>: </b>{{ $transfer->from_warehouse->name }}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td width="50%">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td><b>: </b>{{ $transfer->dmobile_no }}</td>
                                                    </tr>
                                                    {{-- <tr>
                                                        <td><b>Shipping Cost</b></td>
                                                        <td><b>: </b>{{ $transfer->shipping_cost }}</td>
                                                    </tr> --}}
                                                    <tr>
                                                        <td><b>Received Cost</b></td>
                                                        <td><b>: </b>{{ $transfer->received_cost }}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    @if (empty(Auth::user()->warehouse_id))
                                                        <tr>
                                                            ...
                                                            <td><b>:
                                                                </b>{{ $transfer->receive_date ? date('d-M-Y', strtotime($transfer->receive_date)) : '' }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>To</b></td>
                                                            <td><b>: </b>{{ $transfer->to_warehouse->name }}</td>
                                                        </tr>
                                                    @endif
                                                </table>
                                            </td>
                                            ...
                                            @if (!$transfer->hasManyProducts->isEmpty())
                                                ...
                                                @foreach ($transfer->hasManyProducts as $key => $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">{{ $item->product->name }}<br><b>Code:
                                                            </b>{{ $item->product->code }}</td>
                                                        <td class="text-center">{{ $item->unit->unit_name }}</td>
                                                        <td class="text-center">
                                                            {{ number_format($item->transfer_qty, 2, '.', ',') }}</td>
                                                        <td class="text-center">
                                                            {{ number_format($item->receive_qty, 2, '.', ',') }}</td>
                                                        <td class="text-center">
                                                            {{ number_format($item->damage_qty, 2, '.', ',') }}</td>
                                                        @if (empty(Auth::user()->warehouse_id))
                                                            ...
                                                            <td class="text-right no_print">
                                                                {{ number_format(($item->receive_qty ?? 0) * $item->net_unit_cost, 2, '.', ',') }}
                                                            </td>
                                                            <td class="text-right no_print">
                                                                {{ number_format(($item->damage_qty ?? 0) * $item->net_unit_cost, 2, '.', ',') }}
                                                            </td>
                                                        @endif
                                                    </tr>
                                                @endforeach
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <b>{{ number_format($transfer->total_qty, 2, '.', ',') }}</b></td>
                                                    <td class="text-center">
                                                        <b>{{ number_format($total_receive_qty, 2, '.', ',') }}</b></td>
                                                    <td class="text-center">
                                                        <b>{{ number_format($total_damage_qty, 2, '.', ',') }}</b></td>
                                                    @if (empty(Auth::user()->warehouse_id))
                                                        <td></td>
                                                        <td class="text-right no_print">
                                                            <b>{{ number_format($transfer->grand_total, 2, '.', ',') }}</b>
                                                        </td>
                                                        <td class="text-right no_print">
                                                            <b>{{ number_format($total_receive_value, 2, '.', ',') }}</b></td>
                                                        <td class="text-right no_print">
                                                            <b>{{ number_format($total_damage_value, 2, '.', ',') }}</b></td>
                                                    @endif
                                                </tr>
                                            @endif
                                        </tbody>
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td class="text-center">
                                                <div class="font-size-10">
                                                    <p
                                                        ...
                                                        {{ $transfer->created_by }}<br>
                                                        {{ date('Y-m-d', strtotime($transfer->created_at)) }}</p>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10">
                                                    {{-- <p style="margin:0;padding:0;">{{ $transfer->receive_dealer->username ?? '' }}<br> {{ date('Y-m-d',strtotime($transfer->receive_date) ?? '') }}</p> --}}
                                                    <br>
                                                    <br>
                                                    <p class="dashed-border"></p>
                                                    <p
