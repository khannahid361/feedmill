...
class PurchaseReturn extends BaseModel{
     protected $fillable = ['return_no', 'memo_no',  'warehouse_id','supplier_id', 'total_price', 'total_deduction', 'tax_rate', 'total_tax', 'grand_total', 'reason', 'date', 'return_date', 'created_by', 'modified_by'];
     ...
     private function get_datatable_query(){
         ...
         if (!empty($this->_invoice_no)) {
             $query->where('memo_no', 'like', '%' . $this->_invoice_no . '%');
         }
