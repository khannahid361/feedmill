            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('sale.return') }}" class="btn btn-warning btn-sm font-weight-bolder"><i
                ...
                <div class="card-body">
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <form id="sale_update_form" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <input type="hidden" name="dealer_id" value="{{ $sale->dealer_id }}">
                                ...
                                <div class="form-group col-md-4 required">
                                    ...
                                    <input type="text" class="form-control date" name="return_date" id="return_date"
                                ...
                                <div class="form-group col-md-4 required">
                                    ...
                                    <input type="text" class="form-control" name="dealer_name" id="dealer_name"
                                        value="{{ ($sale->dealer->shop_name ?? '') . ' - ' . $sale->dealer->name }}"
                                        readonly />
                                </div>
                                <div class="col-md-12">
                                    <table class="table table-bordered" id="product_table">
                                                    ...
                                                    <tr>
                                                        @php
                                                            ...
                                                            $unit_name = DB::table('units')
                                                                ->where('id', $sale_product->pivot->sale_unit_id)
                                                                ->value('unit_name');
                                                            $total_return_qty = \DB::table('sale_return_products')
                                                                ->where([['memo_no', $sale->memo_no], ['product_id', $sale_product->pivot->product_id], ['batch_no', $sale_product->pivot->batch_no]])
                                                                ->sum('return_qty');
                                                        ...
                                                        <td><input type="text"
                                                                ...
                                                                value="{{ $sale_product->pivot->net_unit_price }}"></td>
                                                        ...
                                                        <input type="hidden" class="product-batch"
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <input type="text" id="total_deduction_ammount"
                                                        class="form-control text-right" placeholder="0.00"
                                                        name="total_deduction" readonly="readonly" />
                                                </td>
                                            </tr>
                                            <tr class="d-none">
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <input type="hidden" name="tax_rate" id="tax_rate"
                                                        value="{{ $sale->order_tax_rate ? $sale->order_tax_rate : 0 }}">
                                                    <input id="total_tax_ammount" tabindex="-1"
                                                        class="form-control text-right valid" name="total_tax"
                                                        placeholder="0.00" readonly="readonly" aria-invalid="false"
                                                        type="text">
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="form-grou col-md-12 text-right pt-5">
                                    <button type="button" class="btn btn-primary btn-sm mr-3" id="save-btn"
                                        onclick="save_data()">Return</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        function save_data() {
            ...
            if (rownumber < 0) {
                ...
                let url = "{{ route('dealer.sale.return.store') }}";
                $.ajax({
                    url: url,
                    type: "POST",
                    data: formData,
                    ...
                    success: function(data) {
                        ...
                        if (data.status == false) {
                            ...
                            if (data.status == 'success') {
                                window.location.replace("{{ route('dealer.sale.return') }}");
                            }
                        }
                    },
