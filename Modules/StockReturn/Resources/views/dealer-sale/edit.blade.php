        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('sale.return') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> Back</a>
                </div>
            </div>
        </div>
                    ...
                    <form id="sale_update_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 required">
                                ...
                                <input type="text" class="form-control" name="dealer_name" id="dealer_name" value="{{ ($sale->dealer->shop_name ?? '').' - '.$sale->dealer->name }}" readonly />
                            </div>
                            <div class="col-md-12">
