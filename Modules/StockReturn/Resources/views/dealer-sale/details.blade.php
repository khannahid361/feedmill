                                    ...
                                    <tr>
                                        <td width="50%">
                                            <div class="invoice-to">
                                                ...
                                                <div class="to"><b>{{ $sale->dealer->shop_name }}</b></div>
                                                <div class="to">{{ $sale->dealer->name }}</div>
                                                <div class="phone">{{ $sale->dealer->mobile }}</div>
                                                @if($sale->dealer->email)<div class="email">{{ $sale->dealer->email }}</div>@endif
                                                @if($sale->dealer->address)<div class="address">{{ $sale->dealer->address }}</div>@endif
                                            </div>
                                        </td>
                                        ...
                                        @if (!$sale->return_products->isEmpty())
                                            @foreach ($sale->return_products as $key => $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center qty">{{ $item->return_qty.' Bag' }}</td>
