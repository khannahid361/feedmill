        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('sales.representative') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> Back</a>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="row">
                                    ...
                                    <x-form.textbox labelName="Salary" name="salary" value="{{ isset($salesman) ? $salesman->salary : '' }}" col="col-md-4" placeholder="Enter Salary"/>
                                                ...
                                                @if (isset($salesman) && !$salesman->areas->isEmpty())
                                                    ...
                                                    @foreach ($salesman->areas as $key => $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><button type="button" class="btn btn-danger btn-block remove-area"><i class="fas fa-trash"></i></button></td>
                                                        </tr>
                                                    @endforeach
                                                @endif
                                            </tbody>
...
$(document).ready(function () {
        ...
        if(upazila_id) {
            $.ajax({
                ...
                success:function(data){
                    ...
                    $.each(data, function(key, value) {area += '<option value="'+ key +'">'+ value +'</option>';});
                    var html = `<tr>
                                   <td>
    ...
    $('#area-table').on('click','.remove-area',function(){$(this).closest('tr').remove();});
    });
