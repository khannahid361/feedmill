            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{ route('sr.product.commission') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> Back</a>
                    </div>
                </div>
            </div>
                        ...
                        <div id="invoice">
                            ...
                            <div class="invoice" style="position: relative;">
                                <div>
                                    ...
                                    <h3>Commission Name : {{$details->name}}</h3><br/>
                                    <table>
                                        <thead>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>{{$details->quanity}}{{'  Pcs'}}</td>
                                            <td>{{$details->product->price * $details->quantity}}</td>
                                            <td>{{$details->commission_percent}}{{'  %'}}</td>
                                            <td>{{$details->commission_amount}}{{'  Tk'}}</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="no_screen" style="position: absolute;top:40%;left:10%;opacity:0.2;"><img src="{{ asset('storage/'.LOGO_PATH.config('settings.logo'))}}" style="width: 80%;" alt="Logo" /></div>
                            </div>
                        </div>
                    </div>
                </div>
