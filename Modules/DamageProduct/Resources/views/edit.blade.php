        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('damage.product') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> Back</a>
                </div>
            </div>
        </div>
                                            ...
                                            @foreach ($sale->sale_products as $key => $sale_product)
                                                <tr>
                                                    @php
                                                        ...
                                                        $total_damage_qty = \DB::table('damage_products')->where([['memo_no',$sale->memo_no],['product_id',$sale_product->pivot->product_id],['batch_no', $sale_product->pivot->batch_no]])->sum('damage_qty');
                                                    ...
                                                    <td class="text-center"><button type="button" class="btn btn-danger btn-md remove-product small-btn"><i class="fas fa-trash"></i></button></td>
