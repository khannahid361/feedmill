                            ...
                            <div class="row">
                                <div class="form-group col-md-4 required">
                                    ...
                                    <input type="text" class="form-control" name="memo_no" id="memo_no"
                                        value="{{ $memo_no }}" readonly />
                                </div>
                                <x-form.textbox labelName="Purchase Date" name="purchase_date" value="{{ date('Y-m-d') }}"
                                    required="required" class="date" col="col-md-4" />
                                ...
                                <x-form.selectbox labelName="Purchase Status" name="purchase_status" class="selectpicker"
                                    required="required" col="col-md-4" onchange="received_qty(this.value)">
                                    @foreach (PURCHASE_STATUS as $key => $value)
                                        <option value="{{ $key }}" {{ $key == 1 ? 'selected' : '' }}>
                                            {{ $value }}</option>
                                    @endforeach
                                </x-form.selectbox>
                                <x-form.selectbox labelName="Factory Store" name="warehouse_id" required="required" col="col-md-4"
                                    class="selectpicker">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered" id="material_table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="col-md-3">
                                                    <select name="materials[1][material_id]" id="material_list_1"
                                                        class="fcs col-md-12 material_name form-control selectpicker"
                                                        onchange="getMaterialDetails(this,1)" data-live-search="true"
                                                        data-row="1">
                                                ...
                                                <td class="material-code_tx_1 text-center" id="material_code_1"
                                                    data-row="1"></td>
                                                <td class="unit-name_1 unit-name text-center" id="unit_name_1"
                                                    data-row="1"></td>
                                                <td><input type="text" class="form-control qty text-center"
                                                        name="materials[1][qty]" id="materials_qty_1" value="1"
                                                        data-row="1"></td>
                                                <td class="received-material-qty d-none"><input type="text"
                                                        class="form-control received text-center"
                                                        name="materials[1][received]" value="1" data-row="1"></td>
                                                <td><input type="text" class="text-right form-control net_unit_cost"
                                                        name="materials[1][net_unit_cost]" id="materials_net_unit_cost_1"
                                                        data-row="1"></td>
                                                ...
                                                <input type="hidden" class="material-id_1" id="material_id_1"
                                                    name="materials[1][id]" data-row="1">
                                                <input type="hidden" class="material-code_1" id="material_code_1"
                                                    name="materials[1][code]" data-row="1">
                                                <input type="hidden" class="material-unit_1" id="material_unit_1"
                                                    name="materials[1][unit]" data-row="1">
                                                <input type="hidden" class="discount-value" id="discount_value_1"
                                                    name="materials[1][discount]" data-row="1">
                                                <input type="hidden" class="tax-rate" id="tax_rate_1"
                                                    name="materials[1][tax_rate]" data-row="1">
                                                <input type="hidden" class="tax-value" id="tax_value_1"
                                                    name="materials[1][tax]" data-row="1">
                                                <input type="hidden" class="subtotal-value" id="subtotal_value_1"
                                                    name="materials[1][subtotal]" data-row="1">
                                            </tr>
                                        </tbody>
                                        <tfoot class="bg-primary">
                                            ...
                                            <th class="text-center"><button type="button"
                                                    class="btn btn-success btn-sm small-btn btn-md add-material"><i
                                ...
                                <div class="col-md-12">
                                    <div class="row" style="justify-content: space-between;padding: 10px 20px;">
                                        ...
                                        <div class="form-group w18">
                                            ...
                                            <input type="text" class="form-control" name="total_labor_cost"
                                                id="labor_cost">
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered">
                                        <thead class="bg-primary">
                                            <th><strong>Items</strong><span class="float-right" id="item">0.00</span>
                                            </th>
                                ...
                                <div class="payment col-md-12 d-none">
                                    <div class="row">
                                        ...
                                        <x-form.selectbox labelName="Payment Method" name="payment_method"
                                            required="required" col="col-md-3">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#material_table').on('click', '.edit-material', function() {
                ...
                var row_material_code = $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')')
            ...
            $('#update-btn').on('click', function() {
                ...
                $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.purchase-unit').val(
            ...
            $('#material_table').on('keyup', '.net_unit_cost', function() {
                ...
                if ($(this).val() < 0 && $(this).val() != '') {
                    ...
                    material_cost[rowindex] = $('#material_table tbody tr:nth-child(' + (rowindex + 1) +
                        ') .net_unit_cost').val();
                }
            ...
            $(document).on('change', '#payment_method', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#purchase_store_form #account_id.selectpicker').selectpicker(
                            'refresh');
                    },
            ...
            function material_row_add(count) {
                ...
                cols +=
                    `<td class="text-center material-code_tx_${count}"  id="material_code_${count}" data-row="${count}"></td>`;
                cols +=
                    `<td class="unit-name_${count} unit-name text-center" id="unit_name_${count}" data-row="${count}"></td>`;
                cols += `<td><input type="text" class="form-control qty text-center" name="materials[` + count +
                    `][qty]" id="materials_qty_` + count + `" value="1" data-row="${count}"></td>`;
                if ($('#purchase_status option:selected').val() == 1) {
                    cols +=
                        `<td class="received-material-qty d-none"><input type="text" class="form-control received text-center" name="materials[` +
                        count + `][received]" value="1" data-row="${count}"></td>`;
                } else if ($('#purchase_status option:selected').val() == 2) {
                    cols +=
                        `<td class="received-material-qty"><input type="text" class="form-control received text-center" name="materials[` +
                        count + `][received]" value="1" data-row="${count}"></td>`;
                } else {
                    cols +=
                        `<td class="received-material-qty d-none"><input type="text" class="form-control received text-center" name="materials[` +
                        count + `][received]" value="0" data-row="${count}"></td>`;
                }
                cols += `<td><input type="text" class="net_unit_cost form-control text-right" name="materials[` +
                    count + `][net_unit_cost]" id="materials_net_unit_cost_${count}" data-row="${count}"></td>`;
                ...
                cols += `<input type="hidden" class="material-id" name="materials[` + count +
                    `][id]" id="material_id_${count}" data-row="${count}">`;
                cols += `<input type="hidden" class="material-code" name="materials[` + count +
                    `][code]" id="material_code_${count}" data-row="${count}">`;
                cols += `<input type="hidden" class="material-unit" name="materials[` + count +
                    `][unit]" id="material_unit_${count}" data-row="${count}">`;
                cols += `<input type="hidden" class="discount-value" name="materials[` + count +
                    `][discount]" id="discount_value_${count}" data-row="${count}">`;
                cols += `<input type="hidden" class="tax-rate" name="materials[` + count +
                    `][tax_rate]" id="tax_rate_${count}" data-row="${count}">`;
                cols += `<input type="hidden" class="tax-value" name="materials[` + count +
                    `][tax]" id="tax_value_${count}" data-row="${count}">`;
                cols += `<input type="hidden" class="subtotal-value" name="materials[` + count +
                    `][subtotal]" id="subtotal_value_${count}" data-row="${count}">`;
                newRow.append(cols);
        ...
        function checkQuantity(purchase_qty, flag, input = 2) {
            ...
            var row_material_code = $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(2)')
                .text();
        ...
        function calculateProductData(quantity, input = 2) {
            unitConversion();
            $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(7)').text((material_discount[
                rowindex] * quantity).toFixed(2));
            $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.discount-value').val((material_discount[
                rowindex] * quantity).toFixed(2));
            $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax-rate').val(tax_rate[rowindex]
                .toFixed(2));
            $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.unit-name').text(unit_name[rowindex]
                .slice(0, unit_name[rowindex].indexOf(",")));
            $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.material-unit').val(unit_name[rowindex]
                .slice(0, unit_name[rowindex].indexOf(",")));
            ...
            $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('td:nth-child(9)').text(sub_total.toFixed(
                2));
            $('#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.subtotal-value').val(sub_total.toFixed(
                2));
            calculateTotal();
        }
        ...
        function received_qty(purchase_status) {
            if (purchase_status == 2) {
                ...
                $(".qty").each(function() {
                    rowindex = $(this).closest('tr').index();
                    $('table#material_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.recieved').val($(
                        this).val());
                });
