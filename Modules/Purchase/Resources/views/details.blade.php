                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td width="50%" class="text-right">
                                                ...
                                                <div class="m-0 date">
                                                    <b>Date:</b>{{ date('d-M-Y', strtotime($purchase->purchase_date)) }}
                                                </div>
                                                <div class="m-0 date">
                                                    <b>Status:</b>{{ $purchase->purchase_status ? PURCHASE_STATUS[$purchase->purchase_status] : 'N/A' }}
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    @php
                                                        ...
                                                        if ($item->pivot->purchase_unit_id) {
                                                            $unit_name = DB::table('units')
                                                                ->where('id', $item->pivot->purchase_unit_id)
                                                                ->value('unit_name');
                                                        }
                                                    @endphp
                                                    <tr>
                                                        ...
                                                        <td class="text-center qty">{{ $item->pivot->qty . ' ' . $unit_name }}
                                                        </td>
                                                        <td class="text-right price">
                                                            {{ number_format($item->pivot->net_unit_cost, 2) }}</td>
                                                        <td class="text-right discount">
                                                            {{ number_format($item->pivot->discount, 2) }}</td>
                                                        {{-- <td class="text-right discount">{{ number_format($item->pivot->labor_cost,2) }}</td> --}}
                                                        <td class="text-right tax">{{ number_format($item->pivot->tax, 2) }}
                                                        </td>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    @if (config('settings.currency_position') == 2)
                                                        {{ number_format($purchase->order_discount, 2) }}
                                                        {{ config('settings.currency_symbol') }}
                                                    @else
                                                        {{ config('settings.currency_symbol') }}
                                                        {{ number_format($purchase->order_discount, 2) }}
                                            ...
                                            <tr>
                                                <td colspan="4"></td>
                                                <td colspan="2" class="text-right">TAX {{ $purchase->order_tax_rate }}%
                                                </td>
                                                <td class="text-right">
                                                    @if (config('settings.currency_position') == 2)
                                                        {{ number_format($purchase->order_tax, 2) }}
                                                        {{ config('settings.currency_symbol') }}
                                                    @else
                                                        {{ config('settings.currency_symbol') }}
                                                        {{ number_format($purchase->order_tax, 2) }}
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    @if (config('settings.currency_position') == 2)
                                                        {{ number_format($purchase->total_labor_cost, 2) }}
                                                        {{ config('settings.currency_symbol') }}
                                                    @else
                                                        {{ config('settings.currency_symbol') }}
                                                        {{ number_format($purchase->total_labor_cost, 2) }}
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    @else
                                                        ...
                                                        {{ config('settings.currency_symbol') }}
                                                        {{ number_format($purchase->grand_totalt - $purchase->paid_amount, 2) }}
                                                    @endif
                                                </td>
                                            </tr>
                                        </tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:0;padding:0;"><b
                                                            class="text-uppercase">{{ $purchase->received_by }}</b></p>
                                                    <p class="dashed-border"></p>
