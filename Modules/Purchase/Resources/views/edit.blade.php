                    ...
                    <form action="" id="purchase_store_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                        ...
                                        @if (!$purchase->purchase_materials->isEmpty())
                                            @foreach ($purchase->purchase_materials as $key => $purchase_material)
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control qty text-center" name="materials[{{ $key+1 }}][qty]" id="materials_{{ $key+1 }}_qty" value="{{ $purchase_material->pivot->qty }}" data-row="{{ $key + 1 }}"></td>
                                                    <td class="received-material-qty d-none"><input type="text" class="form-control received text-center" name="materials[{{ $key+1 }}][received]" value="{{ $purchase_material->pivot->received }}" data-row="{{ $key + 1 }}"></td>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" name="total_labor_cost" id="labor_cost" value="{{ $purchase->total_labor_cost }}">
                            </div>
