                ...
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <form action="" id="sale_store_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="Dealer" name="dealer_id" col="col-md-3" class="fcs">
                                @if (!$dealer->isEmpty())
                            ...
                            <div class="form-group col-md-12 text-center pt-5">
                                <button type="button" class="btn btn-danger btn-sm mr-3" onclick="window.location.replace('{{ route("dealer.sale.add") }}');"><i class="fas fa-sync-alt"></i> Reset</button>
...
<script>
    ...
    function store_data(){
        ...
        if (rownumber < 0) {
            ...
            let url = "{{route('dealer.sale.store')}}";
            $.ajax({
                url: url,
                type: "POST",
                data: formData,
