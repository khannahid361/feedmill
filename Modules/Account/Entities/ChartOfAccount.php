...
class ChartOfAccount extends BaseModel
{
    ...
    'customer_id', 'supplier_id','asm_id', 'salesmen_id', 'dealer_id','bank_id','mobile_bank_id','budget', 'depreciation', 'depreciation_rate', 'status', 'created_by', 'modified_by', 'employee_id'];
