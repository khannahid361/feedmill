                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        @if (permission('customer-receive-access'))
                            <a href="{{ url('customer-receive') }}" class="btn btn-warning btn-sm font-weight-bolder"><i
                            ...
                            <div class="card card-custom card-border">
                                <div class="card-body">
                                    <div id="printableArea" style="width: 100%;margin:0;padding:0;">
                                        ...
                                        <table width="100%" style="margin:0;padding:0;">
                                            <tr>
                                                <td width="100%" class="text-center">
                                                    ...
                                                    @endif
                                                    <p style="font-weight: normal;margin:0;"><b>Date:
                                                        </b>{{ date('d-M-Y') }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <div
                                            style="width:100%;height:2px;border-bottom:1px dotted #454d55;padding-bottom:25px;">
                                        </div>
                                        <div style="width:100%;height:2px;padding-top:5px;"></div>
                                        @php
                                            $account_head = Transaction::with('coa')
                                                ->where('voucher_no', $data->voucher_no)
                                                ->orderBy('id', 'desc')
                                                ->first();
                                        @endphp
                                        <table class="table table-borderless" style="width:100%;" id="invoice-table"
                                            border="0">
                                            <tr>
                                                <td width="25%"><b>Voucher No</b></td>
                                                <td width="5%"><b>:</b></td>
                                                <td width="70%" class="text-left">{{ $data->voucher_no }}</td>
                                            </tr>
                                            <tr>
                                                <td width="25%"><b>Name</b></td>
                                                <td width="5%"><b>:</b></td>
                                                <td width="70%" class="text-left">{{ $data->coa->customer->name }}</td>
                                            </tr>
                                            <tr>
                                                <td width="25%"><b>Amount</b></td>
                                                <td width="5%"><b>:</b></td>
                                                <td width="70%" class="text-left">
                                                    {{ number_format($data->credit, 2, '.', ',') }}Tk</td>
                                            </tr>
                                            <tr>
                                                <td width="25%"><b>Account</b></td>
                                                <td width="5%"><b>:</b></td>
                                                <td width="70%" class="text-left">{{ $account_head->coa->name }}</td>
                                            </tr>
                                            <tr>
                                                <td width="25%"><b>Remarks</b></td>
                                                <td width="5%"><b>:</b></td>
                                                <td width="70%" class="text-left">{{ $data->description }}</td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    <div class="font-size-10"
                                                        style="width:250px;float:right;padding-top:50px;">
