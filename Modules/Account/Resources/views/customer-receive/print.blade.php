        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ url('customer-receive') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> Back</a>
                    @endif
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <div id="printableArea" style="width: 100%;margin:0;padding:0;">
                                    ...
                                    <table class="table table-borderless" style="width:100%;" id="invoice-table" border="0">
                                        ...
                                        <tr>
                                            <td width="25%"><b>Name</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left">{{ $data->coa->customer->name }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;padding-top:50px;">
                                                    <p style="margin:0;padding:0;"><b class="text-uppercase">{{ $data->created_by }}</b><br> {{ date('d-M-Y h:i:s A',strtotime($data->created_at)) }}</p>
