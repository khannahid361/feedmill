                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('salesmen-payment-add'))
                            <a href="{{ route('salesmen.payment.create') }}"  class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> Add New</a>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row justify-content-center">
                            ...
                            <x-form.selectbox labelName="SalesMen" name="salesmen_coa_id"  col="col-md-3" class="selectpicker">
                                @if (!$salesmens->isEmpty())
                                    @foreach ($salesmens as $salesmen)
                                        <option value="{{ $salesmen->coa->id }}">{{ $salesmen->trade_name.' - '.$salesmen->name }}</option>
                                    @endforeach
                                @endif
                            </x-form.selectbox>
                            <div class="col-md-3">
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url" : "{{route('salesmen.payment.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let url   = "{{ route('salesmen.payment.delete') }}";
