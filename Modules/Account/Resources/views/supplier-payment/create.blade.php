                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('supplier-payment-access'))
                            <a href="{{ route('supplier.payment') }}"  class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-circle-left"></i> Back</a>
                        @endif
                    </div>
                </div>
            </div>
                    ...
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <form id="supplier-payment-form" method="post">
                            ...
                            <div class="row">
                                ...
                                <x-form.selectbox labelName="Supplier" name="supplier_id"  onchange="dueAmount(this.value)" required="required"  col="col-md-3" class="selectpicker">
