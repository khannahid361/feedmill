                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('customer-receive-add'))
                            <a href="{{ route('dealer.receive.create') }}"  class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> Add New</a>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row justify-content-center">
                            ...
                            <x-form.selectbox labelName="Dealer" name="customer_id" col="col-md-3" class="selectpicker">
                                @if (!$dealers->isEmpty())
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url" : "{{route('dealer.receive.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let url   = "{{ route('dealer.receive.delete') }}";
