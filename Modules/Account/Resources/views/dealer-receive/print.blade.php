        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ url('dealer-receive') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> Back</a>
                    @endif
                </div>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                <div id="printableArea" style="width: 100%;margin:0;padding:0;">
                                    ...
                                    <table class="table table-borderless" style="width:100%;" id="invoice-table" border="0">
                                        ...
                                        <tr>
                                            <td width="25%"><b>Name</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left">{{ $data->coa->dealer->name }}</td>
                                        </tr>
                                        <tr>
