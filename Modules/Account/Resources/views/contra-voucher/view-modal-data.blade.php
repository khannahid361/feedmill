<div class="col-md-12"><p><b>Voucher No :</b> {{ $voucher[0]->voucher_no }}</p></div>
<div class="col-md-12"><p><b>Date :</b> {{ date('d-M-Y',strtotime($voucher[0]->voucher_date)) }}</p></div>
<div class="col-md-12">
...
<div class="col-md-12"><p><b>Remarks :</b> {{ $voucher[0]->description }}</p></div>
