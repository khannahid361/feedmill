                                                                ...
                                                                <div class="col-md-12 text-center">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4 mb-4">
                                                                            <input type="text" class="form-control text-center finishedQty" value="{{$item->base_unit_qty}}" name="production[{{ $key+1 }}][base_unit_qty]" id="finished_qty" >
                                                                        </div>
                                                                    ...
                                                                    @foreach ($item->materials as $index => $value)
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <input type="hidden" class="form-control text-right " value="{{ $value->qty }}" name="production[{{ $key+1 }}][materials][{{ $index+1 }}][qty]" id="production_{{ $key+1 }}_materials_{{ $index+1 }}_q_ty" data-id="{{ $index+1 }}">

                                                                                <input type="hidden" class="track" data-qty="{{ $value->pivot->qty }}" data-cost="{{ $value->pivot->cost }}" data-stock_qty="{{$value->qty}}" data-total="production_{{ $key+1 }}_materials_{{ $index+1 }}_total" data-tab="{{$index+1 }}"/>
...
{{--                                                                                {{ MATERIAL_TYPE[$value->type] }}--}}
                                                                            ...
                                                                            <td class="text-center">
                                                                                {{ $value->qty }} ({{$value->unit->unit_name}})
...
{{--                                                                                <input type="text" class="form-control text-center qty" value="{{ $value->pivot->qty }}" name="production[{{ $key+1 }}][materials][{{ $index+1 }}][qty]" id="production_{{ $key+1 }}_materials_{{ $index+1 }}_qty"  onkeyup="calculateRowTotal('{{ $key+1 }}','{{ $index+1 }}')" data-id="{{ $index+1 }}">--}}
                                                                                <input type="text" class="form-control text-center damaged_qty" value="{{ $value->pivot->damaged_qty }}" name="production[{{ $key+1 }}][materials][{{ $index+1 }}][damaged_qty]" id="production_{{ $key+1 }}_materials_{{ $index+1 }}_damaged_qty"   data-id="{{ $index+1 }}">
                                                                            </td>
                                                                            <td>
                                                        ...
                                                        <div class="col-md-5">
                                                            <table class="table">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" class="form-control bg-primary text-white text-center other_cost" value="{{$item->other_cost}}" id="other_cost" name="production[{{  $key+1 }}][other_cost]" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><button type="button" class="btn btn-primary btn-block">{{__('Grand Total')}}</button></td>
                                                                    <td><input type="text" class="form-control bg-primary text-white text-center grand_total" value="{{$item->sub_total}}" id="grand_total" name="production[{{  $key+1 }}][sub_total]" readonly/></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" class="form-control bg-primary text-white text-center cost_per_unit" value="{{$item->per_unit_cost}}" id="cost_per_unit" name="production[{{  $key+1 }}][per_unit_cost]" readonly/></td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    @endif
