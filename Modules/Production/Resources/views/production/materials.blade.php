            ...
            @if (!$materials->isEmpty())
                ...
                <tr>
                    <td class="active-bg">
                        ...
                        <input type="hidden" class="form-control text-right" value="{{ $item->q_ty }}" name="production[{{ $tab }}][materials][{{ $key+1 }}][qty]" id="production_{{ $tab }}_materials_{{ $key+1 }}_q_ty" data-id="{{ $key+1 }}" readonly>


                        <input type="hidden" class="track" data-qty="{{ $item->q_ty }}" data-cost="{{ $item->cost }}" data-stock_qty="{{$item->qty}}" data-total="production_{{ $tab }}_materials_{{ $key+1 }}_total" data-tab="{{$tab}}"/>
                    </td>
