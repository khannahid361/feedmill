            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('asm.salary') }}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> SR Salary </a>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function asmSalaryStore(){
            ...
            let url      = "{{route('asm.salary.store')}}";
            $.ajax({
                url           : url,
                type          : "POST",
                data          : formData,
                ...
                success       : function (data) {
                    ...
                    if (data.status == false) {
                        ...
                        if (data.status == 'success') { window.location.replace("{{ route('asm.salary') }}"); }
                    }
                },
