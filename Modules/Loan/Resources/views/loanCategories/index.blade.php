                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        @if (permission('loan-categories-store-update'))
                            <a href="javascript:void(0);" onclick="showFormModal('{{'Add New Name'}}','{{'Save'}}')" class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> {{'Add New'}}</a>
                        @endif
                    </div>
                </div>
            </div>
