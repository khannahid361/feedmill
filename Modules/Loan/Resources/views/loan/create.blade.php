                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="reference_no" name="reference_no" placeholder="{{'Please Enter Reference No'}}"  required="required"/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="loan_amount">{{'Loan Amount'}}</label>
                                <input type="text" class="form-control input" id="loan_amount" name="loan_amount" data-type="loan_amount" placeholder="{{'Please Enter Loan Amount'}}"  required="required"/>
                            </div>
                            <div class="col-md-2"><br/>
                                <label for="loan_percentage_percent">{{'Loan Percentage(%)'}}</label>
                                <input type="text" class="form-control input" id="loan_percentage_percent" name="loan_percentage_percent" data-type="loan_percentage_percent" placeholder="{{'Please Enter Loan Percentage'}}" required="required"/>
                            </div>
                            <div class="col-md-2"><br/>
                                <label for="loan_percentage_tk">{{'Loan Percentage(tk)'}}</label>
                                <input type="text" class="form-control input" id="loan_percentage_tk" name="loan_percentage_tk" data-type="loan_percentage_tk" placeholder="{{'Please Enter Loan Percentage'}}" required="required"/>
                            </div>
                            <div class="col-md-4"><br/>
                            ...
                            <div class="col-md-4"><br/>
                                ...
                                <input type="text" class="form-control" id="processing_charge" name="processing_charge" placeholder="{{'Please Enter Processing Charge'}}"/>
                            </div>
                            <div class="col-md-4"><br/>
                                <label for="misc_charge">{{'MISC Charge'}}</label>
                                <input type="text" class="form-control" id="misc_charge" name="misc_charge" placeholder="{{'Please Enter MISC Charge'}}"/>
                            </div>
                            <div class="col-md-4"><br/>
                            ...
                            <div class="col-md-4"><br/>
                                ...
                                <input type="text" class="form-control input" id="total_installment_month" name="total_installment_month" data-type="total_installment_month" placeholder="{{'Please Enter Total Installment Month'}}" required="required"/>
                            </div>
                            <div class="col-md-4"><br/>
