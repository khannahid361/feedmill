...
//    }
    private function get_datatable_query(){
        ...
        $query = self::where(['voucher_type' => self::TYPE,'credit' => 0]);
//        $query = self::with('loan','loan.bank')->where(['voucher_type' => self::TYPE,'debit' => 0]);
    ...
    public function count_all(){
        return self::where(['voucher_type' => self::TYPE,'credit' => 0])->get()->count();
    }
}
