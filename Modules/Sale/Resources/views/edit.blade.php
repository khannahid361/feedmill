                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 required">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $sale->customer->name . ' - ' . $sale->customer->shop_name }}" readonly />
                                    ...
                                    <table class="table table-bordered" id="product_table">
                                        ...
                                        <tfoot class="bg-primary">
                                            ...
                                            <th id="total-qty" class="text-center font-weight-bolder">
                                                {{ $sale->total_qty }}</th>
                                            <th id="total-free-qty" class="text-center font-weight-bolder">
                                                {{ $sale->total_free_qty }}</th>
                                            <th></th>
                                            <th id="total-tax" class="text-right font-weight-bolder">
                                                {{ number_format($sale->total_tax, 2, '.', ',') }}</th>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control payment_method" id="payment_method"
                                                name="payment_method" onchange="paymentMethod()">
                                                <option value="">{{ __('Please Select') }}</option>
                                                @foreach (SALE_PAYMENT_METHOD as $key => $value)
                                                    <option value="{{ $key }}"
                                                        @if ($key == $sale->payment_method) selected="selected" @endif>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" id="account_id" name="account_id">
                                                <option value="{{ $sale->account_id }}">{{ $account->name ?? '' }}
                                                </option>
                                            </select>
                                        </div>
