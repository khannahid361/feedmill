            ...
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    @if (permission('employee-leave-add'))
                        <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Labour Leave Application')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.selectbox labelName="{{__('Labour')}}" name="labour_id" id="employee_id" col="col-md-4" class="selectpicker">
                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th>{{__('file.Leave Purpose')}}</th>
                                        <th>{{__('file.Creation Date')}}</th>
...
@include('hrm::labour_leave.modal')
@endsection
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('labourLeave.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url         = "{{route('labourLeave.store.or.update')}}";
