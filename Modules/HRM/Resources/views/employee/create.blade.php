                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <x-form.selectbox
                                                                                    ...
                                                                                    <option
                                                                                        value="2">{{ __('Female') }}</option>
                                                                                </x-form.selectbox>
                                                                                <div
                                                                                    class="form-group col-md-12 required">
                                                                                    <label
                                                                                        for="date_of_birth">{{__('file.Date of Birth')}}</label>
                                                                                    <input type="date"
                                                                                ...
                                                                                <x-form.selectbox
                                                                                    ...
                                                                                    class="selectpicker">
                                                                                    <option
                                                                                        value="1">{{ __('Married') }}</option>
                                                                                    <option
                                                                                        value="2">{{ __('Single') }}</option>
                                                                                    <option
                                                                                        value="3">{{ __('Divorced') }}</option>
                                                                                    <option
                                                                                        value="4">{{ __('Separated') }}</option>
                                                                                    <option
                                                                                        value="5">{{ __('Widowed') }}</option>
                                                                                </x-form.selectbox>
                                                                                <x-form.textbox
                                                                                ...
                                                                                <div
                                                                                    class="form-group col-md-12 required">
                                                                                    <label
                                                                                        for="sale_date">{{__('file.Joining Date')}}</label>
                                                                                    <input type="date"
                                                                                           class="form-control date"
                                                                                           id="joining_date"
                                                                                           name="joining_date"
