                ...
                <div class="card-header flex-wrap py-5">
                    <form method="POST" id="form-filter" class="col-md-12 px-0">
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="Department" name="department" col="col-md-4"
                                              class="selectpicker">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{route('hrm.shift.datatable.data')}}",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '#save-btn', function () {
                ...
                let url = "{{route('hrm.shift.store.or.update')}}";
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let url = "{{ route('hrm.shift.delete') }}";
