            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{route('salaryPayment')}}" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i>{{__('file.Back')}}</a>
                    </div>
                </div>
            </div>
                                ...
                                <div>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td width="30%">
                                                <div class="invoice-to">
                                                    <div class="text-grey-light text-left">{{$payslip->employee->name}}</div>
                                                    <div class="text-grey-light text-left">{{$payslip->employee->employee_id}}</div>
                                                    <div class="text-grey-light text-left">{{$payslip->employee->department->name}}</div>
                                                    <div class="text-grey-light text-left">{{$payslip->employee->designation->name}}</div>
                                                </div>
                                            </td>
...
{{--                                                <div class="m-0 date text-left"><b>{{__('file.Status')}}:</b></div>--}}
                                    ...
                                    <div class="box" style="display: flex">
                                        <table border="0" cellspacing="0" cellpadding="0" style="width:50% !important;" class="table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" colspan="4">{{__('file.Total Allowance')}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td class="text-right">{{__('file.House Rent Allowance')}} :</td>
                                                    <td class="text-right">{{$allowance->house_rent_allowance}}/-TK</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right">{{__('file.Medical Allowance')}} :</td>
                                                    <td class="text-right">{{$allowance->medical_allowance}}/-TK</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right">{{__('file.Transport Allowance')}} :</td>
                                                    <td class="text-right">{{$allowance->transport_allowance}}/-TK</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right" >{{__('file.Mobile Allowance')}} :</td>
                                                    <td class="text-right">{{$allowance->mobile_allowance}}/-TK</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right">{{__('file.Other Allowance')}} :</td>
                                                    <td class="text-right">{{$allowance->other_allowance}}/-TK</td>
                                                </tr>
                                                @php
                                                    $allowances = 0;
                                                @endphp
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" style="width:50% !important;" class="table-bordered">
                                            <thead>
                                            <tr>
                                                <th class="text-center"  colspan="4">{{__('file.Total Deduction')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td class="text-right" colspan="2">{{__('file.Attendance Deduction')}} :</td>
                                                    <td class="text-right" colspan="2" style="padding-right: 4%;">0/-TK</td><br>
                                                </tr>
                                                <tr>
                                                    <td class="text-right" colspan="2">{{__('file.Provident Fund Deduction')}} :</td>
                                                    <td class="text-right" colspan="2" style="padding-right: 4%;">{{$deduction->provident_fund_deduction}}/-TK</td><br>
                                                </tr>
                                                <tr>
                                                    <td class="text-right" colspan="2">{{__('file.Tax Deduction')}} :</td>
                                                    <td class="text-right" colspan="2" style="padding-right: 4%;">{{$deduction->tax_deduction}}/-TK</td><br>
                                                </tr>
                                                <tr>
                                                    <td class="text-right" colspan="2">{{__('file.Other Deduction')}} :</td>
                                                    <td class="text-right" colspan="2" style="padding-right: 4%;">{{$deduction->other_deduction}}/-TK</td><br>
                                                </tr>
                                    ...
                                    <table>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-right">{{$allowance->basic_salary}}/-TK</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="text-right"></td>
                                                <td colspan="2"  class="text-right">{{__('TOTAL ALLOWANCE')}}:</td>
                                                <td class="text-right">
                                                    {{$payslip->total_allowance}}/-TK
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="text-right"></td>
                                                <td colspan="2"  class="text-right">{{__('GROSS SALARY')}}:</td>
                                                <td class="text-right">{{($payslip->gross_salary)}}/-TK</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">{{$payslip->net_salary}}/-TK</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"></td>
                                                <td colspan="2"  class="text-right">{{__('file.DUE AMOUNT')}}:</td>
                                                <td class="text-right">{{$payslip->net_salary - $payslip->payment_amount}}/-TK</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"></td>
                                                <td colspan="2"  class="text-right">{{__('PAYABLE')}}:</td>
                                                <td class="text-right">{{$payslip->payment_amount}}/-TK</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                    <table>
