                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-md-6 form-group required">
                                                        ...
                                                        <input type="hidden" class="form-control"  name="employee_id" id="employee_id" readonly value="{{$employee->id}}">
                                                        <input type="hidden" class="form-control"  name="joining_month" id="joining_month" readonly value="{{$employee->joining_month}}">
