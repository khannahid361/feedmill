        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    @if (permission('increment-add'))
                        <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Increment')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="{{__('file.Category Name')}}" name="name" col="col-md-4" />
                        <div class="col-md-8">
                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th>{{__('file.Increment Amount')}}</th>
                                        <th>{{__('file.Increment Month')}}</th>
                                        <th>{{__('file.Increment Purpose')}}</th>
...
@push('scripts')
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('increment.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url         = "{{route('increment.store.or.update')}}";
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url         = "{{ route('increment.delete') }}";
