            ...
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    @if (permission('branch-add'))
                        <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Branch')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('branch.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url         = "{{route('branch.store.or.update')}}";
