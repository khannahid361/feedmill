    ...
    <div class="container-fluid">
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                <form action="{{ route("salaryPayment.salary.create") }}" method="get" class="col-md-12 px-0">
                    <div class="row">
                        <div class="col-md-1"></div>
                        <x-form.selectbox labelName="{{__('Employee Salary')}}" name="employee_id" id="employee_id" col="col-md-4" class="selectpicker">
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('salaryPayment.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url         = "{{ route('salaryPayment.delete') }}";
