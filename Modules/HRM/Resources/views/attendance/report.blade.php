            ...
            <div class="card card-custom">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3" id="">
                                ...
                                <select class="form-control selectpicker" name="employee_id"
                                        id="employee_id" data-live-search="true" required>
                                ...
                                <div style="margin-top:28px;">
                                    <div style="margin-top:28px;">
                                        ...
                                        <button id="btn-filter"
                                                ...
                                                type="button"
                                                data-toggle="tooltip" onclick="report();" data-theme="dark"
                ...
                <div class="card-body">
                    ...
                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row" id="invoice" style="width: 100%;">
                            <style>
                                body,html {
...
@push('scripts')
    ...
    <script>
        function report() {
            ...
            if (from_date && to_date && employee_id) {
                $.ajax({
                    url: "{{ route('attendance.report.data') }}",
                    type: "POST",
                    data: { id: employee_id, from_date: from_date, to_date: to_date, _token: _token },
                ...
                $('#report').empty();
                notification('error', 'Please select Employee, From Date, and To Date');
            }
        }
