        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('Add New Designation','Save')" class="btn btn-primary btn-sm font-weight-bolder">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="Designation Name" name="name" col="col-md-4" />
                        <div class="col-md-8">
...
<script>
    ...
    $(document).ready(function(){
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('designation.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
            ...
            "buttons": [
                @if (permission('designation-report'))
                {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('designation.store.or.update')}}";
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('designation.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('designation.bulk.delete')}}";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('designation.change.status') }}";
