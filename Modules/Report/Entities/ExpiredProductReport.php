...
class ExpiredProductReport extends BaseModel
{
    ...
    private function get_datatable_query()
    {
        ...
        $query = self::with('warehouse:id,name')->whereNotNull('end_date');
        ...
        if (!empty($this->_start_date) && !empty($this->_end_date)) {
            $query->whereDate('start_date','>=', $this->_start_date)->whereDate('end_date','<=', $this->_end_date);
        }
