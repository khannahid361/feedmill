...
class DealerSalesReport extends BaseModel
{
    protected $fillable = [
        'memo_no', 'dealer_id', 'sale_date', 'document', 'item', 'total_qty', 'total_free_qty', 'total_tax', 'total_price', 'total_commission', 'total_delivery_quantity',
    ...
    {
        $this->column_order = [
            's.id', 's.memo_no', 's.dealer_id', 's.item', 's.total_price', 's.order_tax_rate', 's.order_tax',
