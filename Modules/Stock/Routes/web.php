...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('depo-wise-sales-delivery', 'WarehouseProductDeliveryController@delivery')->name('warehouse.product.delivery.ledger');
    Route::post('depo-wise-sales-delivery/data', 'WarehouseProductDeliveryController@deliveredProductLedgerData')->name('warehouse.product.delivery.ledger.data');
});
