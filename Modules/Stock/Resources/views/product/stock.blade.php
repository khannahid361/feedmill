            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('convert.product.bag') }}" class="btn btn-primary btn-sm font-weight-bolder"><i
                                class="fas fa-plus-circle"></i> Add Product Bag</a>
                    </div>
                </div>
            </div>
                                ...
                                <table id="dataTable" class="table table-bordered table-hover">
                                    ...
                                    <tfoot>
                                        <tr class="bg-primary">
                                            ...
                                            <th></th>
                                            <th></th>
                                            <th style="text-align: right !important;font-weight:bold;color:white;">Total
                                            </th>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('warehouse.product.stock.datatable.data') }}",
                    "type": "POST",
                    "data": function(data) {
                ...
                "footerCallback": function(row, data, start, end, display) {
                    ...
                    for (let index = 7; index < 8; index++) {
                        ...
                        $(api.column(7).footer()).html('= ' + number_format(pageTotal));
