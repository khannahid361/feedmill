...
<?php $component->withAttributes(['labelName' => 'Warehouse','name' => 'warehouse_id','required' => 'required','col' => 'col-md-4','class' => 'selectpicker']); ?>
                                <?php if(!$warehouses->isEmpty()): ?>
                                    <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($warehouse->id); ?>" <?php echo e($production->warehouse_id == $warehouse->id ? 'selected' : ''); ?>><?php echo e($warehouse->name); ?></option>
                        ...
                        <ul class="nav nav-tabs nav-tabs-2" id="form-tab" role="tablist" style="border-bottom: 0px !important;justify-content: space-between;">
                            ...
                            <?php if(!$production->products->isEmpty()): ?>
                                ...
                                <li class="nav-item mx-0 mb-3" id="tab<?php echo e($key+1); ?>">
                                    <a class="nav-link <?php echo e($key == 0 ? 'active' : ''); ?> text-center step  step-<?php echo e($key+1); ?>" data-toggle="tab" href="#tab-<?php echo e($key+1); ?>" role="tab">Product-<?php echo e($key+1); ?></a>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                            ...
                            <div class="tab-content">
                                <?php if(!$production->products->isEmpty()): ?>
                                    <?php $__currentLoopData = $production->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane <?php echo e($key == 0 ? 'active' : ''); ?>  step step-<?php echo e($key+1); ?>  p-3" id="tab-<?php echo e($key+1); ?>" role="tabpanel">
                                                    ...
                                                    <div class="card-body py-5">
                                                        <div class="row">
                                                            <div class="form-group col-md-12 required">
                                                                <label >Product</label>
                                                                <input type="text" class="form-control" value="<?php echo e($item->product->name); ?>">
                                                                <input type="hidden" class="form-control" value="<?php echo e($item->id); ?>" name="production[<?php echo e($key+1); ?>][production_product_id]" id="production_<?php echo e($key+1); ?>_production_product_id">
                                                                <input type="hidden" class="form-control" value="<?php echo e($item->product_id); ?>" name="production[<?php echo e($key+1); ?>][product_id]" id="production_<?php echo e($key+1); ?>_product_id">
                                                            </div>
                                                            <div class="form-group col-md-3 required">
                                                                <label >Total Year</label>
                                                                <select name="production[<?php echo e($key+1); ?>][year]" id="production_<?php echo e($key+1); ?>_year"  onchange="generateDate(this.value,<?php echo e($key+1); ?>)" class="form-control selectpicker">
                                                                    <?php for($i = 1; $i <= 3; $i++): ?>
                                                                    <option value="<?php echo e($i); ?>" <?php echo e($i == $item->year ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                                                    <?php endfor; ?>
                                                                </select>
                                                            </div>
                                                            <div class="form-group col-md-3 required">
                                                                <label for="mfg_date">Mfg. Date</label>
                                                                <input type="text" class="form-control date" name="production[<?php echo e($key+1); ?>][mfg_date]" id="production_<?php echo e($key+1); ?>_mfg_date" value="<?php echo e($item->mfg_date); ?>" readonly />
                                                            </div>
                                                            <div class="form-group col-md-3 required">
                                                                <label for="exp_date">Exp. Date</label>
                                                                <input type="text" class="form-control date" name="production[<?php echo e($key+1); ?>][exp_date]" id="production_<?php echo e($key+1); ?>_exp_date" value="<?php echo e($item->exp_date); ?>" readonly />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <?php $__currentLoopData = $item->materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                <?php echo e(MATERIAL_TYPE[$value->type]); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Production\Resources/views/production/edit.blade.php ENDPATH**/ ?>