...
<?php endif; ?>
                            ...
                            <div class="form-group col-md-12 text-center pt-5">
                                <button type="button" class="btn btn-danger btn-sm mr-3" onclick="window.location.replace('<?php echo e(route("dealer.sale.add")); ?>');"><i class="fas fa-sync-alt"></i> Reset</button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/DealerSale\Resources/views/create.blade.php ENDPATH**/ ?>