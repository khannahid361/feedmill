                                    ...
                                    <table class="table table-bordered pb-5" id="material_table_<?php echo e($key + 1); ?>">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control text-center" value="<?php echo e($item->expected_unit_qty); ?>" name="production[<?php echo e($key+1); ?>][expected_unit_qty]" id="production_<?php echo e($key+1); ?>_expected_unit_qty" readonly>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\laragon\www\insaf\Modules/Production\Resources/views/production/operation.blade.php ENDPATH**/ ?>