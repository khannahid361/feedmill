                ...
                <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="active-bg">
                            ...
                            <input type="hidden" class="form-control text-right" value="<?php echo e($item->cost); ?>"
                            ...
                            <input type="hidden" class="track" data-qtys="<?php echo e($item->q_ty); ?>"
                                data-cost="<?php echo e($item->cost); ?>" data-stock_qty="<?php echo e($item->qty); ?>"
...
<?php /**PATH H:\laragon\www\insaf\Modules/Production\Resources/views/production/materials.blade.php ENDPATH**/ ?>