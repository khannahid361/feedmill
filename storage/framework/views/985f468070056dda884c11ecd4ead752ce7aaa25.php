            ...
            <div class="card-body">
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <form id="sale_update_form" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <input type="hidden" name="dealer_id" value="<?php echo e($sale->dealer_id); ?>">
                            ...
                            <div class="form-group col-md-4 required">
                                ...
                                <input type="text" class="form-control" name="dealer_name" id="dealer_name" value="<?php echo e(($sale->dealer->shop_name ?? '').' - '.$sale->dealer->name); ?>" readonly />
                            </div>
                            <div class="col-md-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/StockReturn\Resources/views/dealer-sale/edit.blade.php ENDPATH**/ ?>