                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control daterangepicker-filed" value="<?php echo e(date('Y-m-d').' To '.date('Y-m-d')); ?>">
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Salesman','name' => 'salesmen_id','col' => 'col-md-3','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Salesman','name' => 'salesmen_id','col' => 'col-md-3','class' => 'selectpicker']); ?>
                            ...
                            <?php $__currentLoopData = $salesmen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($salesman->id); ?>"><?php echo e($salesman->name.' - '.$salesman->phone); ?></option>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo e(route('sr.commission.report.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
    ...
    $('#btn-reset').click(function () {
        $('#form-filter')[0].reset();
        $('#start_date, #end_date').val("<?php echo e(date('Y-m-d')); ?>");
        $('#salesmen_id').empty();
...
function getSalesmenList(warehouse_id){
    $.ajax({
        url:"<?php echo e(url('warehouse-wise-salesmen-list')); ?>/"+warehouse_id,
        type:"GET",
        dataType:"JSON",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Report\Resources/views/salesman-commission-report.blade.php ENDPATH**/ ?>