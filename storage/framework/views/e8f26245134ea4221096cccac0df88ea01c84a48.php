        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="<?php echo e(route('employee')); ?>" class="btn btn-secondary btn-sm font-weight-bolder">
                                    ...
                                    <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                        <div class="col-xl-12 col-xxl-12">
                                            ...
                                            <form class="form mt-0 mt-lg-10 fv-plugins-bootstrap fv-plugins-framework" id="store_or_update_form" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="update_id" id="update_id" value="<?php echo e(isset($employee) ? $employee->id : ''); ?>">
                                                <!-- begin: Basic Information-->
                                                <div class="pb-5 step step-1" data-wizard-type="step-content" data-wizard-state="current">
                                                    <?php echo $__env->make('hrm::employee.section.basic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                                <!-- end: Basic Information -->
                                                <!-- begin: Positional Information -->
                                                <div class="pb-5 step step-2" data-wizard-type="step-content">
                                                    <?php echo $__env->make('hrm::employee.section.positional', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                                <!-- end: Positional Information -->

                                                <!-- begin: Supervisor -->
                                                <div class="pb-5 step step-3" data-wizard-type="step-content">
                                                    <?php echo $__env->make('hrm::employee.section.supervisor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                                <!-- end: Supervisor -->
                                                <!-- begin: Biographical Information -->
                                                <div class="pb-5 step step-4" data-wizard-type="step-content">
                                                    <?php echo $__env->make('hrm::employee.section.biographical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                                <!-- end: Biographical Information -->
                                                <!-- begin: Educational Information -->
                                                <div class="pb-5 step step-5" data-wizard-type="step-content">
                                                    <?php echo $__env->make('hrm::employee.section.educational', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                                <!-- end: Educational Information -->
                                                <!-- begin: Job Experience -->
                                                <div class="pb-5 step step-6" data-wizard-type="step-content">
                                                    <?php echo $__env->make('hrm::employee.section.experience', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                                <!-- end: Job Experience -->
                                                <!-- begin: Emergency Contacts -->
                                                <div class="pb-5 step  step-7" data-wizard-type="step-content">
                                                    <?php echo $__env->make('hrm::employee.section.emergency', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
        ...
        success: function (data) {
            ...
            if (data.status == false) {
                ...
                if (data.status == 'success') {
                    window.location.replace("<?php echo e(route('employee')); ?>");
                }
            }
...
var education_count = "<?php echo e(count($employee->educations)); ?>";
<?php else: ?>   
...
*******************************************/
<?php if(isset($employee) && !$employee->professional_informations->isEmpty()): ?> 
var experience_count = "<?php echo e(count($employee->professional_informations)); ?>";
<?php else: ?>   
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/employee/form.blade.php ENDPATH**/ ?>