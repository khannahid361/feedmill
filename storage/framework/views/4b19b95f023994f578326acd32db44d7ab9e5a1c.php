...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => ''.e(__('Dealer')).'','name' => 'dealer_id','col' => 'col-md-4','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => ''.e(__('Dealer')).'','name' => 'dealer_id','col' => 'col-md-4','class' => 'selectpicker']); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function report_data() {
            ...
            let dealer_id = $('#dealer_id').find(":selected").val();
            if( _('start_date').value == '' || _('end_date').value == ''){
                notification('error','Please choose date!');
                return;
            }
            $.ajax({
                url        :"<?php echo e(route('dealer.product.ledger.data')); ?>",
                type       :"POST",
                data       :{start_date:start_date,end_date:end_date,product_id:product_id,category_id:category_id,dealer_id:dealer_id,_token:_token},
                beforeSend : function(){
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/StockLedger\Resources/views/productLedger/dealerIndex.blade.php ENDPATH**/ ?>