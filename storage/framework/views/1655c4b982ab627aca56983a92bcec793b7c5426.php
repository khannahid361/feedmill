            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <?php if(permission('supplier-payment-create')): ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Supplier','name' => 'supplier_coa_id','col' => 'col-md-3','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Supplier','name' => 'supplier_coa_id','col' => 'col-md-3','class' => 'selectpicker']); ?>
                                <?php if(!$suppliers->isEmpty()): ?>
                                    <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($supplier->coa->id); ?>"><?php echo e($supplier->trade_name.' - '.$supplier->name); ?></option>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url" : "<?php echo e(route('supplier.payment.datatable.data')); ?>",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let url   = "<?php echo e(route('supplier.payment.delete')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\laragon\www\insaf\Modules/Account\Resources/views/supplier-payment/index.blade.php ENDPATH**/ ?>