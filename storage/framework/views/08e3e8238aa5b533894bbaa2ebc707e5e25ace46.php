                            ...
                            <div class="row">
                                <div class="form-group col-md-4 required">
                                    ...
                                    <input type="text" class="form-control" name="voucher_no" id="voucher_no"
                                        value="<?php echo e($voucher_no); ?>" readonly />
                                </div>
                                <div class="form-group col-md-4 required">
                                    <label for="voucher_date">Date</label>
                                    <input type="text" class="form-control date" name="voucher_date" id="voucher_date"
                                        value="<?php echo e(date('Y-m-d')); ?>" readonly />
                                </div>
                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Dealer','name' => 'dealer_id','onchange' => 'dueAmount(this.value)','required' => 'required','col' => 'col-md-4','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Dealer','name' => 'dealer_id','onchange' => 'dueAmount(this.value)','required' => 'required','col' => 'col-md-4','class' => 'selectpicker']); ?>
                                    <?php if(!empty($dealers)): ?>
                                        <?php $__currentLoopData = $dealers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        $(document).on('change', '#payment_type', function() {
            $.ajax({
                ...
                type: "POST",
                data: {
                    payment_method: $('#payment_type option:selected').val(),
                    _token: _token
                },
        ...
        function dueAmount(dealer_id) {
            $.ajax({
                url: "<?php echo e(url('dealer/previous-balance')); ?>/" + dealer_id,
                type: "GET",
                dataType: "JSON",
                beforeSend: function() {
                    $('#due_amount').val('0.00');
        ...
        function store_data() {
            ...
            let url = "<?php echo e(route('dealer.receive.store')); ?>";
            $.ajax({
                url: url,
                type: "POST",
                data: formData,
                ...
                success: function(data) {
                    ...
                    if (data.status == false) {
                        ...
                        window.location.replace("<?php echo e(route('dealer.receive')); ?>");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Account\Resources/views/dealer-receive/create.blade.php ENDPATH**/ ?>