                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?php if(config('settings.currency_position') == 2): ?>
                                                    <?php echo e(number_format(($purchase->total_cost - $purchase->paid_amount - $purchase->order_discount),2)); ?> <?php echo e(config('settings.currency_symbol')); ?>

                                                <?php else: ?>
                                                    <?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format(($purchase->total_cost - $purchase->paid_amount - $purchase->order_discount),2)); ?>
