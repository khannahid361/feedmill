            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="<?php echo e(route('labourSalaryPayment')); ?>" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i><?php echo e(__('file.Back')); ?></a>
                    </div>
                </div>
            </div>
                                ...
                                <div>
                                        ...
                                        <tr>
                                            <td width="20%">
                                                <div class="invoice-to">
                                                    <div class="text-grey-light text-right"><b><?php echo e(__('Labour Name')); ?> :</b></div>
                                                    <div class="text-grey-light text-right"><b><?php echo e(__('Labour ID')); ?> :</b></div>
                                                </div>
                                            </td>
                                            <td width="30%">
                                                <div class="invoice-to">
                                                    <div class="text-grey-light text-left"><?php echo e($payslip->labour->name); ?></div>
                                                    <div class="text-grey-light text-left"><?php echo e($payslip->labour->labour_id); ?></div>
                                    ...
                                    <div class="box" style="display: flex">
                                        <table border="0" cellspacing="0" cellpadding="0" style="width:50% !important;" class="table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" colspan="4"><?php echo e(__('file.Others Allowance')); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" style="width:50% !important;" class="table-bordered">
                                            <thead>
                                            <tr>
                                                <th class="text-center"  colspan="4"><?php echo e(__('file.Others Deduction')); ?></th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                    ...
                                    <table>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo e($payslip->basic_salary); ?>/-TK</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="text-right"></td>
                                                <td colspan="2"  class="text-right"><?php echo e(__('TOTAL ALLOWANCE')); ?>:</td>
                                                <td class="text-right">
                                                    <?php echo e($payslip->others_allowance); ?>/-TK
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="text-right"></td>
                                                <td colspan="2"  class="text-right"><?php echo e(__('GROSS SALARY')); ?>:</td>
                                                <td class="text-right"><?php echo e(($payslip->total_gross_salary)); ?>/-TK</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo e($payslip->net_payable); ?>/-TK</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"></td>
                                                <td colspan="2"  class="text-right"><?php echo e(__('file.DUE AMOUNT')); ?>:</td>
                                                <td class="text-right"><?php echo e(($payslip->net_payable + $payslip->bonus) - $payslip->payable_salary); ?>/-TK</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4"></td>
                                                <td colspan="2"  class="text-right"><?php echo e(__('PAYABLE')); ?>:</td>
                                                <td class="text-right"><?php echo e($payslip->payable_salary); ?>/-TK</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                    <table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/labour/salary-payment/payslip.blade.php ENDPATH**/ ?>