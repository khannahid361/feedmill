                                            ...
                                            data-live-search-placeholder="Search">
                                                ...
                                                <?php if(!$materials->isEmpty()): ?>
                                                    <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($material->id); ?>"><?php echo e($material->material_name); ?> -- <?php echo e($material->unit->unit_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                        </div>
...
$(document).ready(function () {
    ...
    function add_more_material_field(row){
        html = ` <div class="row row_remove">
                    ...
                    <div class="form-group col-md-5 required">
                        <input type="text" class="form-control qty text-center" name="materials[`+row+`][qty]" id="materials_`+row+`_qty" value="1" data-row="${row}">
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Product\Resources/views/create.blade.php ENDPATH**/ ?>