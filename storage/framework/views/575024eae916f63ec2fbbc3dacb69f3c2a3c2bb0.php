                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <?php if(permission('bank-add')): ?>
                            <a class="btn btn-primary btn-sm font-weight-bolder" href="<?php echo e(route('sr.salary.add')); ?>"><i class="fas fa-plus-circle"></i> Add New</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'SR','name' => 'salarytable_id','required' => 'required','col' => 'col-md-3','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'SR','name' => 'salarytable_id','required' => 'required','col' => 'col-md-3','class' => 'selectpicker']); ?>
    ...
    <script>
        ...
        $(document).ready(function(){
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url" : "<?php echo e(route('sr.salary.datatable.data')); ?>",
                    "type": "POST",
                    "data": function (data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Salary\Resources/views/srSalary/index.blade.php ENDPATH**/ ?>