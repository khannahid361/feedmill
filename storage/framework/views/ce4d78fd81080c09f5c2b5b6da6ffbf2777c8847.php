        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <?php if(permission('debit-voucher-add')): ?>
                    <a href="<?php echo e(route('debit.voucher.create')); ?>"  class="btn btn-primary btn-sm font-weight-bolder"> 
...
<?php echo $__env->make('account::debit-voucher.view-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo e(route('debit.voucher.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '.view_data', function () {
        ...
        if (id) {
            $.ajax({
                url: "<?php echo e(route('debit.voucher.view')); ?>",
                type: "POST",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Account\Resources/views/debit-voucher/list.blade.php ENDPATH**/ ?>