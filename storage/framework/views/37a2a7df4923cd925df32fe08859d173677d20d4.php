          ...
          <?php echo csrf_field(); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 required">
                        <label for="salary_month" class="col-sm-12 control-label" style="padding-left: 0px;"><?php echo e(__('file.Deduction Name')); ?></label>
                        <input type="text" class="form-control" name="deduction_name" id="deduction_name" required="required" placeholder="Deduction Name"/>
                    </div>
                    <div class="col-md-12 required">
                        <label for="salary_month" class="col-sm-12 control-label" style="padding-left: 0px;"><?php echo e(__('file.Deduction Month')); ?></label>
                    ...
                    <div class="col-md-12 required">
                        <label for="salary_month" class="col-sm-12 control-label" style="padding-left: 0px;"><?php echo e(__('file.Deduction Amount')); ?></label>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => ''.e(__('file.Deduction Description')).'','name' => 'deduction_description','required' => 'required','col' => 'col-md-12','placeholder' => 'Enter Deduction Description']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => ''.e(__('file.Deduction Description')).'','name' => 'deduction_description','required' => 'required','col' => 'col-md-12','placeholder' => 'Enter Deduction Description']); ?>
...
<?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/deduction/modal.blade.php ENDPATH**/ ?>