                            ...
                            <div class="card-body">
                                <div id="printableArea" style="width: 100%;margin:0;padding:0;">
                                    ...
                                    <table class="table table-borderless" style="width:100%;" id="invoice-table" border="0">
                                        ...
                                        <tr>
                                            <td width="25%"><b>Name</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left"><?php echo e($data->coa->dealer->name); ?></td>
                                        </tr>
                                        <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\laragon\www\insaf\Modules/Account\Resources/views/dealer-receive/print.blade.php ENDPATH**/ ?>