            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="<?php echo e(route('dealer.sale.return')); ?>" class="btn btn-warning btn-sm font-weight-bolder">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <?php if(config('settings.address')): ?>
                                                    <p style="font-weight: normal;margin:0;">
                                                        <?php echo e(config('settings.address')); ?></p>
                                                <?php endif; ?>
                                                <p style="font-weight: normal;margin:0;"><b>Date: </b><?php echo e(date('d-M-Y')); ?>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    <div class="to"><b><?php echo e($sale->dealer->shop_name); ?></b></div>
                                                    <div class="to"><?php echo e($sale->dealer->name); ?></div>
                                                    <div class="phone"><?php echo e($sale->dealer->mobile); ?></div>
                                                    <?php if($sale->dealer->email): ?>
                                                        <div class="email"><?php echo e($sale->dealer->email); ?></div>
                                                    <?php endif; ?>
                                                    <?php if($sale->dealer->address): ?>
                                                        <div class="address"><?php echo e($sale->dealer->address); ?></div>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            <td width="50%" class="text-right">
                                                ...
                                                <div class="m-0 date"><b>Return
                                                        Date:</b><?php echo e(date('d-M-Y', strtotime($sale->return_date))); ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                    <table border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <?php if(!$sale->return_products->isEmpty()): ?>
                                                <?php $__currentLoopData = $sale->return_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center qty"><?php echo e($item->return_qty . ' Bag'); ?></td>
                                                        <td class="text-right price">
                                                            <?php echo e(number_format($item->product_rate, 2)); ?></td>
                                                        <td class="text-right discount">
                                                            <?php echo e(number_format($item->deduction_rate, 2)); ?></td>
                                                        <td class="text-right total">
                                                            <?php if(config('settings.currency_position') == 2): ?>
                                                                <?php echo e(number_format($item->total + $item->deduction_amount, 2)); ?>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php if(config('settings.currency_position') == 2): ?>
                                                        <?php echo e(number_format($sale->total_deduction, 2)); ?>
                                            ...
                                            <tr class="d-none">
                                                <td colspan="1" class="text-right">TAX
                                                    <?php echo e($sale->tax_rate ? $sale->tax_rate : ''); ?>%</td>
                                                <td class="text-right">
                                                    <?php if(config('settings.currency_position') == 2): ?>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:left;">
                                                    ...
                                                    <p style="margin:0;padding:0;">Dealer Signature & Date</p>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;">
                                                    <p style="margin:35px 0 0 0;padding:0;"><?php echo e($sale->created_by); ?><br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/StockReturn\Resources/views/dealer-sale/details.blade.php ENDPATH**/ ?>