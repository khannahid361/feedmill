                                    ...
                                    <tr>
                                        <td width="50%">
                                            <div class="invoice-to">
                                                ...
                                                <?php if($sale->dealer->email): ?><div class="email"><?php echo e($sale->dealer->email); ?></div><?php endif; ?>
                                                <?php if($sale->dealer->address): ?><div class="address"><?php echo e($sale->dealer->address); ?></div><?php endif; ?>
                                            </div>
                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right total">
                                                        <?php if(config('settings.currency_position') == 2): ?>
                                                            <?php echo e(number_format($item->total + $item->deduction_amount,2)); ?> <?php echo e(config('settings.currency_symbol')); ?>

                                                        <?php else: ?>
                                                            <?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($item->total + $item->deduction_amount,2)); ?>
