        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <?php if(permission('deduction-add')): ?>
                        <a href="javascript:void(0);" onclick="showFormModal('<?php echo e(__('file.Add New Deduction')); ?>','<?php echo e(__('file.Save')); ?>')" class="btn btn-primary btn-sm font-weight-bolder">
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => ''.e(__('file.Deduction Name')).'','name' => 'deduction_name','col' => 'col-md-4']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => ''.e(__('file.Deduction Name')).'','name' => 'deduction_name','col' => 'col-md-4']); ?>
                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th><?php echo e(__('file.Deduction Name')); ?></th>
                                        <th><?php echo e(__('file.Employee Name')); ?></th>
                                        <th><?php echo e(__('file.Deduction Month')); ?></th>
                                        <th><?php echo e(__('file.Designation Amount')); ?></th>
                                        <th><?php echo e(__('file.Designation Purpose')); ?></th>
...
<?php echo $__env->make('hrm::deduction.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/labour/deduction/index.blade.php ENDPATH**/ ?>