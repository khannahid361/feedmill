        ...
        <div class="col-md-12 text-center">
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <input type="text" class="form-control text-center finishedQty" value="" name="finished_qty_<?php echo e($tab); ?>" id="finished_qty_<?php echo e($tab); ?>" >
                </div>
            ...
            <?php if(!$materials->isEmpty()): ?>
                ...
                <tr>
                    <td>
                        ...
                        <input type="hidden" class="track" data-qty="<?php echo e($item->q_ty); ?>" data-cost="<?php echo e($item->cost); ?>" data-total="production_<?php echo e($tab); ?>_materials_<?php echo e($key+1); ?>_total" data-tab="<?php echo e($tab); ?>"/>
                    </td>
