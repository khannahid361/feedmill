...
<?php $component->withAttributes(['labelName' => 'Supplier','name' => 'supplier_id','col' => 'col-md-3','class' => 'selectpicker']); ?>
                            ...
                            <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($supplier->id); ?>" data-coaid="<?php echo e($supplier->coa->id); ?>" data-name="<?php echo e($supplier->name); ?>"><?php echo e($supplier->name.' - '.$supplier->mobile); ?></option>
