                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <?php if(!empty($product->image)): ?>
                            <div class="col-md-3">
                                <img src="<?php echo e(asset('storage/' . PRODUCT_IMAGE_PATH . $product->image)); ?>"
                                    alt="<?php echo e($product->name); ?>" style="max-width: 100%;">
                            </div>
                        <?php else: ?>
                            <div class="col-md-3">
                                <img src="<?php echo e(asset('images/product.svg')); ?>" alt="<?php echo e($product->name); ?>"
                                    style="max-width: 60%;">
                            </div>
                        <?php endif; ?>
                        <div class="col-md-9 pt-5 table-responsive">
                            <table class="table table-borderless table-hover">
                                <tr>
                                    ...
                                    <td class="text-center"><b>:</b></td>
                                    <td><?php echo e(BARCODE_SYMBOL[$product->barcode_symbology] ?? ''); ?></td>
                                </tr>
                                <tr>
                                    <td><b>Barcode</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    ...
                                    <td><b>Cost</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    <td>BDT <?php echo e(number_format($product->cost, 2)); ?></td>
                                </tr>
                                <tr>
                                    <td><b>Unit</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    <td><?php echo e($product->base_unit->unit_name . '(' . $product->base_unit->unit_code . ')'); ?></td>
                                    

                                    <td><b>Price</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    <td>BDT <?php echo e(number_format($product->base_unit_price, 2)); ?></td>
                                    
                                </tr>
                                <tr>
                                    <td><b>Stock Qunatity Base Unit</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    <td><?php echo e(number_format($product->base_unit_qty, 2)); ?></td>
                                ...
                                <tr>
                                    <td><b>Tax</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    <td><?php echo e($product->tax->rate); ?>%</td>
                                    <td><b>Tax Method</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    <td><?php echo e(TAX_METHOD[$product->tax_method]); ?></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><b>:</b></td>
                                    <td><?php echo e(date('j-F-Y h:i:sA', strtotime($product->created_at))); ?></td>

                                </tr>
                                <tr>
                                    <td><b>Updated By</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    <td><?php echo e($product->modified_by ? $product->modified_by : ''); ?></td>
                                    <td><b>Updated At</b></td>
                                    <td class="text-center"><b>:</b></td>
                                    <td><?php echo e($product->modified_by ? date('j-F-Y h:i:sA', strtotime($product->updated_at)) : ''); ?>
                                ...
                                <div class="tab-pane fade show active" id="materials" role="tabpanel"
                                    ...
                                    <?php if(!$product->product_material->isEmpty()): ?>
                                        <table class="table table-bordered table-striped" style="width: 50%">
                                            <?php $__currentLoopData = $product->product_material; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($item->material_name); ?></td>
                                                    <td><?php echo e($product->product_materials[$key]->qty); ?></td>
                                                    <?php
