            ...
            <div class="card w-100" style="border: 0;">
                <div class="card-body">
                    <div class="py-5 text-center">
                        <h2 class="font-weight-bolder">Dealer Sign In</h2>
                    ...
                    <div style="width: 80%;margin:0 auto;">
                        ...
                        <?php endif; ?>
                        <form class="form" action="<?php echo e(route('dealer.panel.login.handle')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\insaf\resources\views/dealer-auth/login.blade.php ENDPATH**/ ?>