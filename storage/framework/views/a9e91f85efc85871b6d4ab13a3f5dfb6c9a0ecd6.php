                ...
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <select class="form-control col-md-4" name="customer_id">
                            <option value=""><?php echo e('Please Select Customer'); ?></option>
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($customer->coa->id); ?>"><?php echo e($customer->name); ?></option>
...
$(document).ready(function(){
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo e(route('customer.receipt.list.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
    ...
    $('#btn-reset').click(function () {
        $('#form-filter')[0].reset();
        $('#warehouse_id,#district_id,#start_date,#end_date').val("");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Report\Resources/views/customer-receipt-list.blade.php ENDPATH**/ ?>