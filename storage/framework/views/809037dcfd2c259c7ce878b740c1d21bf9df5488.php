...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo e(route('paid.customer.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
...
function customer_list()
{
    ...
    $.ajax({
        url:"<?php echo e(url('paid-customer-list')); ?>",
        type:"POST",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Customer\Resources/views/paid-customer/index.blade.php ENDPATH**/ ?>