...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Memo No.','name' => 'memo_no','col' => 'col-md-3']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Memo No.','name' => 'memo_no','col' => 'col-md-3']); ?>
...
$(document).ready(function(){
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url" : "<?php echo e(route('today.sales.report.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [{
            ...
            },
            {
                ...
                "title"    : function(){  return "<?php echo e($page_title); ?> <br>"+warehouse_name; },
                "orientation"  : "landscape", //portrait
                "pageSize"     : "legal", //A3,A5,A6,legal,letter
                "exportOptions": {
                    columns    : function (index, data, node) { return table.column(index).visible(); }
                },
            ...
            },
            {
                ...
                'className':'btn btn-secondary btn-sm text-white',
                "title": function(){
                    return "<?php echo e($page_title); ?> <br>"+warehouse_name;
                },
                "filename": function(){
                    return  warehouse_name+"-<?php echo e(strtolower(str_replace(' ','-',$page_title))); ?>";
                },
                "exportOptions": {
    ...
    $('#btn-reset').click(function () {
        window.location.replace("<?php echo e(url('today-sales-report')); ?>");
    });
});
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Report\Resources/views/today-sales-report.blade.php ENDPATH**/ ?>