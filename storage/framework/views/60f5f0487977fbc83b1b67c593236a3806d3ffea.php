...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Supplier','name' => 'supplier_id','required' => 'required','col' => 'col-md-4']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Supplier','name' => 'supplier_id','required' => 'required','col' => 'col-md-4']); ?>
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered" id="material_table">
                                    ...
                                    <tbody>
                                        ...
                                        <td class="received-material-qty d-none"><input type="text" class="form-control received text-center" name="materials[1][received]" value="1" data-row="1"></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\insaf_erp_b2gsoft\Modules/Purchase\Resources/views/create.blade.php ENDPATH**/ ?>