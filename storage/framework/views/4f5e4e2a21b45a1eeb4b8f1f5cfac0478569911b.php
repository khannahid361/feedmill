                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="font-size-10">
                                                <p style="margin:35px 0 0 0;padding:0;text-transform: capitalize;font-weight:normal;"><?php echo e($transfer->created_by); ?><br> <?php echo e(date('d-M-Y h:i:s A',strtotime($transfer->created_at))); ?></p>
                                        ...
                                        <td class="text-center">
                                            <div class="font-size-10">
                                                <p style="margin:0;padding:0;"><?php echo e($transfer->receiver->username); ?><br> <?php echo e(date('d-M-Y h:i:s A',strtotime($transfer->receive_date))); ?></p>
                                                <p class="dashed-border"></p>
