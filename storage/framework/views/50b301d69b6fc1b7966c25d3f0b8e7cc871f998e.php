...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => ''.e(__('Employee')).'','name' => 'labour_id','id' => 'labour_id','col' => 'col-md-4','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => ''.e(__('Employee')).'','name' => 'labour_id','id' => 'labour_id','col' => 'col-md-4','class' => 'selectpicker']); ?>
                            <?php $__currentLoopData = $labour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($row->id); ?>"><?php echo e($row->name); ?>--<?php echo e($row->labour_id); ?></option>
...
<?php echo $__env->make('hrm::labour.salary-advance.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo e(route('labourSalaryAdvance.datatable.data')); ?>",
                "type": "POST",
                "data": function (data) {
                    data.employee_id    = $("#form-filter #labour_id").val();
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url         = "<?php echo e(route('labourSalaryAdvance.store.or.update')); ?>";
        ...
        $(document).on('click', '.edit_data', function () {
            ...
            if (id) {
                $.ajax({
                    url: "<?php echo e(route('labourSalaryAdvance.edit')); ?>",
                    type: "POST",
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #labour_id').val(data.labour_id);
                            ...
                            $('#store_or_update_modal .modal-title').html(
                                '<i class="fas fa-edit text-white"></i> <span><?php echo e(__('file.Edit')); ?> </span>');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/labour/salary-advance/index.blade.php ENDPATH**/ ?>