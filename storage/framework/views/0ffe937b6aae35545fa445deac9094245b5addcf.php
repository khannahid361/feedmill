                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            if(data.material_image){
                                ...
                                $('#store_or_update_form .img_').attr('src',`<?php echo e('storage/'.MATERIAL_IMAGE_PATH); ?>`+data.material_image);
                            }else{
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\laragon\www\insaf\Modules/Material\Resources/views/index.blade.php ENDPATH**/ ?>