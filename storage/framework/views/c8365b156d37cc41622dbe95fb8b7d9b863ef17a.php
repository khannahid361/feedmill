                            ...
                            <div class="card-body">
                                <div id="printableArea" style="width: 100%;margin:0;padding:0;">
                                    ...
                                    <table class="table table-borderless" style="width:100%;" id="invoice-table" border="0">
                                        ...
                                        <tr>
                                            <td width="25%"><b>Name</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left"><?php echo e($data->coa->customer->name); ?></td>
                                        </tr>
                                        <tr>
                                            <td width="25%"><b>Amount</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left"><?php echo e(number_format($data->credit,2,'.',',')); ?>Tk</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="text-center">
                                                <div class="font-size-10" style="width:250px;float:right;padding-top:50px;">
                                                    <p style="margin:0;padding:0;"><b class="text-uppercase"><?php echo e($data->created_by); ?></b><br> <?php echo e(date('d-M-Y h:i:s A',strtotime($data->created_at))); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\laragon\www\insaf\Modules/Account\Resources/views/customer-receive/print.blade.php ENDPATH**/ ?>