...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Warehouse','name' => 'warehouse','col' => 'col-md-3','required' => 'required','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Warehouse','name' => 'warehouse','col' => 'col-md-3','required' => 'required','class' => 'selectpicker']); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url" : "<?php echo e(route('material.stock.report.datatable.data')); ?>",
                    "type": "POST",
                    "data": function (data) {
                ...
                "buttons": [
                        <?php if(permission('material-stock-report-access')): ?>{
                        'extend'   : 'colvis',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\insaf_erp_b2gsoft\Modules/Stock\Resources/views/material/index.blade.php ENDPATH**/ ?>