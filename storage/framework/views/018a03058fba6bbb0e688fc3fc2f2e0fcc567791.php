                                ...
                                <div>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <div class="invoice-to">
                                                    ...
                                                    <div class="to"><?php echo e($sale->customer->shop_name); ?></div>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <?php if(!$sale->sale_products->isEmpty()): ?>
                                            <?php $__currentLoopData = $sale->sale_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center qty"><?php echo e($item->pivot->free_qty.' '.$unit_name); ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?php if(config('settings.currency_position') == 2): ?>
                                                    <?php echo e(number_format($sale->previous_due,2,'.','')); ?> <?php echo e(config('settings.currency_symbol')); ?>

                                                <?php else: ?>
                                                    <?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($sale->previous_due,2,'.','')); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?php if(config('settings.currency_position') == 2): ?>
                                                    <?php echo e(number_format($sale->net_total,2,'.','')); ?> <?php echo e(config('settings.currency_symbol')); ?>

                                                <?php else: ?>
                                                    <?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format(($sale->grand_total + $sale->previous_due),2,'.','')); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <?php if(config('settings.currency_position') == 2): ?>
                                                    <?php echo e(number_format($sale->due_amount,2,'.','')); ?> <?php echo e(config('settings.currency_symbol')); ?>

                                                <?php else: ?>
                                                    <?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($sale->due_amount,2,'.','')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Sale\Resources/views/details.blade.php ENDPATH**/ ?>