        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="<?php echo e(route('menu')); ?>" type="button" class="btn btn-secondary btn-sm font-weight-bolder mr-2"> <i class="fas fa-arrow-circle-left"></i> Back</a>
                    <?php if(permission('menu-module-add')): ?>
...
<?php echo $__env->make('module.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(document).ready(function(){
    ...
    function menuItems(){
        $.ajax({
            url:"<?php echo e(route('menu.items')); ?>",
            type:"POST",
            data:{id:"<?php echo e($menu->id); ?>",_token:_token},
    ...
    $(document).on('change','.dd',function(e){
        $.post('<?php echo e(route("menu.module.order",["menu"=>$menu->id])); ?>',{
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        $.ajax({
            url: "<?php echo e(route('menu.module.store.or.update')); ?>",
            type: "POST",
            data: formData,
            dataType: "JSON",
            contentType: false,
    ...
    $(document).on('click', '.edit_data', function () {
        ...
        if (id) {
            $.ajax({
                url: "<?php echo e(route('menu.module.edit')); ?>",
                type: "POST",
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo e(route('menu.module.delete')); ?>",
                    type: "POST",
                    data: { id: id, _token: _token},
                    dataType: "JSON",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\feedmill\resources\views/module/index.blade.php ENDPATH**/ ?>