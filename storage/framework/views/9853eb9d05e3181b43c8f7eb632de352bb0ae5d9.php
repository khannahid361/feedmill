...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Mobile Bank Name','name' => 'bank_name','col' => 'col-md-3']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Mobile Bank Name','name' => 'bank_name','col' => 'col-md-3']); ?>
...
<?php echo $__env->make('mobilebank::modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo e(route('mobilebank.datatable.data')); ?>",
                "type": "POST",
                "data": function (data) {
            ...
            "buttons": [
                <?php if(permission('mobile-bank-report')): ?>
                {
                ...
                <?php endif; ?> 
                <?php if(permission('mobile-bank-bulk-delete')): ?>
                {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "<?php echo e(route('mobilebank.store.or.update')); ?>";
        ...
        $(document).on('click', '.edit_data', function () {
            ...
            if (id) {
                $.ajax({
                    url: "<?php echo e(route('mobilebank.edit')); ?>",
                    type: "POST",
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let url    = "<?php echo e(route('mobilebank.change.status')); ?>";
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let name  = $(this).data('name');
            let row   = table.row($(this).parent('tr'));
            let url   = "<?php echo e(route('mobilebank.delete')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/MobileBank\Resources/views/index.blade.php ENDPATH**/ ?>