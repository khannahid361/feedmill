<div id="kt_header_mobile" class="header-mobile  header-mobile-fixed ">
    <div class="mobile-logo">
            ...
            <a href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('storage/'.LOGO_PATH.config('settings.logo'))); ?>" style="width: 60px;" alt="Logo" />
            </a>
            <?php else: ?>
...
</div><?php /**PATH C:\laragon\www\insaf\Modules/DealerPanel\Resources/views/includes/mobile-header.blade.php ENDPATH**/ ?>