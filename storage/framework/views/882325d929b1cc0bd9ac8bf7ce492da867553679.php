                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <?php if(permission('customer-receive-add')): ?>
                            <a href="<?php echo e(route('dealer.receive.create')); ?>"  class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> Add New</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Dealer','name' => 'customer_id','col' => 'col-md-3','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Dealer','name' => 'customer_id','col' => 'col-md-3','class' => 'selectpicker']); ?>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url" : "<?php echo e(route('dealer.receive.datatable.data')); ?>",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let url   = "<?php echo e(route('dealer.receive.delete')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Account\Resources/views/dealer-receive/index.blade.php ENDPATH**/ ?>