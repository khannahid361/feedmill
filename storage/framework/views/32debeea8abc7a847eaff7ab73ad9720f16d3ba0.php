                        ...
                        <form action="" id="commission_store_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="date" id="from_date" class="form-control datetimepicker"
                                        name="from_date">

                                </div>
                                <div class="form-group col-md-3">
                                    <label for="name">Choose To Date</label>
                                    <input type="date" id="to_date" class="form-control datetimepicker" name="to_date">
