...
<?php endif; ?>
                            <div class="form-group col-md-4">
                                <button type="button" class="btn btn-success btn-block" style="margin-top: 25px"><?php echo e('Journal Voucher'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    let url = "<?php echo e(url('journal-voucher/store')); ?>";
    $.ajax({
        url: url,
        type: "POST",
        data: formData,
        ...
        success: function (data) {
            ...
            if (data.status == false) {
                ...
                if (data.status == 'success') {
                    window.location.replace("<?php echo e(url('journal-voucher')); ?>");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Account\Resources/views/journal-voucher/create.blade.php ENDPATH**/ ?>