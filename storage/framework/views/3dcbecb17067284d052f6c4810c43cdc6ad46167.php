        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="<?php echo e(route('purchase.return')); ?>" class="btn btn-warning btn-sm font-weight-bolder"> 
                        ...
                        <div class="invoice overflow-auto">
                            <div>
                                    ...
                                    <tr>
                                        <td width="50%">
                                            <div class="invoice-to">
                                                ...
                                                <div class="to"><?php echo e($purchase->supplier->company_name); ?></div>
                                        ...
                                        <td width="50%" class="text-right">
                                            ...
                                            <div class="m-0 date"><b>Return No.: <?php echo e($purchase->return_no); ?></b></div>
                                            <div class="m-0 date"><b>Invoice No.: </b><?php echo e($purchase->invoice_no); ?></div>
                                            <div class="m-0 date"><b>Date:</b><?php echo e(date('d-M-Y',strtotime($purchase->return_date))); ?></div>
                                        </td>
                                    </tr>
                                </table>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody>
                                        <?php if(!$purchase->return_materials->isEmpty()): ?>
                                            <?php $__currentLoopData = $purchase->return_materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    $unit_name = '';
                                                    if($item->unit_id)
                                                    {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><?php echo e($item->material->material_name); ?></td>
                                                    <td class="text-center qty"><?php echo e($item->return_qty.' '.$unit_name); ?></td>
                                                    <td class="text-right price"><?php echo e(number_format($item->material_rate,2)); ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="4" rowspan="3" class="text-left">
                                                <h6><b>Reason:</b></h6>
                                                <p class="text-justify font-weight-normal"><?php echo e($purchase->reason); ?></p>
                                            </td>
                                            <td colspan="1"  class="text-right">TOTAL DEDUCTION</td>
                                            <td class="text-right">
                                                <?php if(config('settings.currency_position') == 2): ?>
                                                    <?php echo e(number_format($purchase->total_deduction,2)); ?> <?php echo e(config('settings.currency_symbol')); ?>

                                                <?php else: ?> 
                                                    <?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->total_deduction,2)); ?>

                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr class="d-none">
                                            <td colspan="1"  class="text-right">TAX <?php echo e($purchase->tax_rate ? $purchase->tax_rate : ''); ?>%</td>
                                            <td class="text-right">
                                                <?php if(config('settings.currency_position') == 2): ?>
                                                    <?php echo e(number_format($purchase->total_tax,2)); ?> <?php echo e(config('settings.currency_symbol')); ?>

                                                <?php else: ?> 
                                                    <?php echo e(config('settings.currency_symbol')); ?> <?php echo e(number_format($purchase->total_tax,2)); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="font-size-10" style="width:250px;float:right;">
                                                <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase"><?php echo e($purchase->created_by); ?></b><br> <?php echo e(date('d-M-Y h:i:s A',strtotime($purchase->created_at))); ?></p>
                                                <p class="dashed-border"></p>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/StockReturn\Resources/views/purchase/details.blade.php ENDPATH**/ ?>