                    ...
                    <div class="card-body">
                        <div class="col-md-12 text-center">
                            <h5>
                                ...
                                <b>Mfg. Date:</b> <?php echo e(date('d-M-Y', strtotime($production->start_date))); ?>

                                <?php if($production->end_date): ?>
                                    <br><b>Expired Date:</b> <?php echo e(date('d-M-Y', strtotime($production->end_date))); ?>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-center">
                                                            <?php echo e(date('d-M-Y', strtotime($item->mfg_date))); ?></td>
                                                        <td class="text-center">
                                                            <?php echo e(date('d-M-Y', strtotime($item->exp_date))); ?></td>
                                                        <td class="text-center">
                                                            <?php echo e($item->product->unit->unit_name . ' (' . $item->product->unit->unit_code . ')'); ?>

                                                        </td>
                                                        <td class="text-center"><?php echo e($item->base_unit_qty); ?></td>
                                                        <td class="text-center"><?php echo e($item->used_wastage_qty); ?></td>
                                                        <td class="text-center"><?php echo e($item->recyclable_wastage_qty); ?></td>
                                                        <td class="text-center"><?php echo e($item->permanent_wastage_qty); ?></td>
                                                        <?php if($item->has_coupon == 1): ?>
                                                            <td class="text-center"><?php echo e($item->total_coupon); ?></td>
                                                            <td class="text-center">
                                                                <?php echo e(number_format($item->coupon_price, 2, '.', '')); ?></td>
                                                            <td class="text-center">
                                                                <?php echo e(date('d-M-Y', strtotime($item->coupon_exp_date))); ?></td>
                                                        <?php endif; ?>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <?php if(!$item->materials->isEmpty()): ?>
                                                        <?php $__currentLoopData = $item->materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td> <?php echo e($value->material_name . ' (' . $value->material_code . ')'); ?>

                                                                </td>
                                                                <td class="text-center"><?php echo e(MATERIAL_TYPE[$value->type]); ?>
                                                                ...
                                                                <td class="text-right">
                                                                    <?php echo e(number_format($value->pivot->cost, 2, '.', '')); ?> </td>
                                                                <td class="text-center">
                                                                    <?php echo e(number_format($value->pivot->qty, 2, '.', '')); ?> </td>
                                                                <td class="text-center"><?php echo e($value->pivot->used_qty); ?></td>
                                                                <td class="text-center">
                                                                    <?php echo e(number_format($value->pivot->cost * $value->pivot->used_qty, 2, '.', '')); ?>
                                                        ...
                                                        <tr>
                                                            <td colspan="6" class="text-right font-weight-bold">Labor
                                                                Cost</td>
                                                            <td colspan="1" class="text-right">
                                                                <?php echo e($item->labor_cost ?? 0); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="6" class="text-right font-weight-bold">Other
                                                                Cost</td>
                                                            <td colspan="1" class="text-right">
                                                                <?php echo e($item->other_cost ?? 0); ?></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="6" class="text-right font-weight-bold">Per Unit
                                                                Cost</td>
                                                            <td colspan="1" class="text-right">
                                                                <?php echo e($item->per_unit_cost ? number_format($item->per_unit_cost, 2, '.', '') : ''); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Production\Resources/views/production/view.blade.php ENDPATH**/ ?>