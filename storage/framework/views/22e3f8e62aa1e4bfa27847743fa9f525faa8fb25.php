                        ...
                        <form action="" id="sale_store_form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 required">
                                    ...
                                    <input type="hidden" name="customer_id_hidden" id="customer_id_hidden" value="<?php echo e($sale->dealer_id); ?>">
                                </div>
                                        ...
                                        <?php if(!$sale->sale_products->isEmpty()): ?>
                                            <?php $__currentLoopData = $sale->sale_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sale_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="available-qty_tx_<?php echo e($key + 1); ?> text-center" id="products_available_qty_<?php echo e($key + 1); ?>" data-row="<?php echo e($key + 1); ?>"><?php echo e($stock_qty); ?></td>
                                                    ...
                                                    <input type="hidden" class="stock-qty_vl_<?php echo e($key+1); ?> form-control text-center" name="products[<?php echo e($key+1); ?>][stock_qty]"  value="<?php echo e($stock_qty); ?>" id="products_stock_qty_<?php echo e($key + 1); ?>" data-row="<?php echo e($key + 1); ?>">
...
<?php $component->withAttributes(['labelName' => 'Payment Method','name' => 'payment_method','onchange' => 'account_list(this.value)','required' => 'required','col' => 'col-md-4']); ?>
                                            <?php $__currentLoopData = SALE_PAYMENT_METHOD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" <?php if($sale->payment_method): ?> <?php echo e($sale->payment_method == $key ? 'selected' : ''); ?> <?php endif; ?>><?php echo e($value); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                                        <div class="form-group required col-md-4 <?php if($sale->payment_method): ?> <?php echo e($sale->payment_method != 1  ? '' : 'd-none'); ?> <?php endif; ?> reference_no">
                                            <label for="reference_no">Reference No</label>
                                            <input type="text" class="form-control" name="reference_no" id="reference_no" value="<?php echo e($sale->reference_no); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-md-12 text-center pt-5">
                                    <a href="<?php echo e(url('sale')); ?>" class="btn btn-danger btn-sm mr-3"><i class="far fa-window-close"></i> Cancel</a>
