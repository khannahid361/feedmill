            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <a href="<?php echo e(route('dealer.sale')); ?>" class="btn btn-warning btn-sm font-weight-bolder"><i
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3 required">
                                    ...
                                    <input type="text" class="form-control" name="memo_no" id="memo_no"
                                        value="<?php echo e($sale->memo_no); ?>" />
                                </div>
                                <div class="form-group col-md-3 required">
                                    <label for="sale_date">Sale Date</label>
                                    <input type="text" class="form-control date" name="sale_date" id="sale_date"
                                        value="<?php echo e($sale->sale_date); ?>" readonly />
                                </div>
                                <div class="form-group col-md-3 required">
                                    <label>Customer</label>
                                    <input type="text" class="form-control" value="<?php echo e($sale->dealer->name); ?>" readonly />
                                    <input type="hidden" name="customer_id_hidden" id="customer_id_hidden"
                                        value="<?php echo e($sale->dealer_id); ?>">
                                </div>
                                                    ...
                                                    <tr>
                                                        <?php
                                                            ...
                                                            $units = DB::table('units')
                                                                ->where('base_unit', $sale_product->pivot->sale_unit_id)
                                                                ->orWhere('id', $sale_product->pivot->sale_unit_id)
                                                                ->get();
                                                            $warehouse_product = DB::table('warehouse_product')
                                                                ->where(['product_id' => $sale_product->pivot->product_id])
                                                                ->sum('bag_qty');
                                                            $stock_qty = $sale_product->pivot->qty + ($warehouse_product ? $warehouse_product : 0);
                                                            $unit_name = [];
                                                            $unit_operator = [];
                                                        ...
                                                        <td class="product-code_tx_<?php echo e($key + 1); ?> text-center"
                                                            id="products_code_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>"><?php echo e($sale_product->code); ?></td>
                                                        <td class="unit-name_tx_<?php echo e($key + 1); ?> text-center"
                                                            id="products_unit_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>"><?php echo e($temp_unit_name[0]); ?></td>
                                                        <td class="available-qty_tx_<?php echo e($key + 1); ?> text-center"
                                                            id="products_available_qty_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                            <?php echo e($stock_qty - $sale_product->pivot->qty); ?></td>
                                                        <td><input type="text" class="form-control qty text-center"
                                                                name="products[<?php echo e($key + 1); ?>][qty]"
                                                                id="products_qty_<?php echo e($key + 1); ?>"
                                                                value="<?php echo e(number_format($sale_product->pivot->qty, 2, '.', '')); ?>"
                                                                data-row="<?php echo e($key + 1); ?>"></td>
                                                        <td><input type="text" class="form-control free_qty text-center"
                                                                name="products[<?php echo e($key + 1); ?>][free_qty]"
                                                                id="products_free_qty_<?php echo e($key + 1); ?>"
                                                                value="<?php echo e(number_format($sale_product->pivot->free_qty, 2, '.', '')); ?>"
                                                                data-row="<?php echo e($key + 1); ?>"></td>
                                                        <td><input type="text"
                                                                class="fcs text-right form-control net_unit_price"
                                                                name="products[<?php echo e($key + 1); ?>][net_unit_price]"
                                                                id="products_net_unit_price_<?php echo e($key + 1); ?>"
                                                                value="<?php echo e($product_price); ?>"
                                                                data-row="<?php echo e($key + 1); ?>"></td>
                                                        <td class="tax text-right" id="tax_tx_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                            <?php echo e(number_format((float) $sale_product->pivot->tax, 2, '.', '')); ?>

                                                        </td>
                                                        <td class="sub-total text-right"
                                                            id="sub_total_tx_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                            <?php echo e(number_format((float) $sale_product->pivot->total, 2, '.', '')); ?>

                                                        </td>
                                                        <input type="hidden" class="product-id_vl_<?php echo e($key + 1); ?>"
                                                            name="products[<?php echo e($key + 1); ?>][id]"
                                                            value="<?php echo e($sale_product->pivot->product_id); ?>"
                                                            id="products_id_vl_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <input type="hidden" class="product-code_vl_<?php echo e($key + 1); ?>"
                                                            name="products[<?php echo e($key + 1); ?>][code]"
                                                            value="<?php echo e($sale_product->code); ?>"
                                                            id="products_code_vl_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <input type="hidden" class="batch-no_vl_<?php echo e($key + 1); ?>"
                                                            name="products[<?php echo e($key + 1); ?>][batch_no]"
                                                            id="products_batch_no_<?php echo e($key + 1); ?>"
                                                            value="<?php echo e($sale_product->pivot->batch_no); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <input type="hidden"
                                                            class="stock-qty_vl_<?php echo e($key + 1); ?> form-control text-center"
                                                            name="products[<?php echo e($key + 1); ?>][stock_qty]"
                                                            value="<?php echo e($stock_qty - $sale_product->pivot->qty); ?>"
                                                            id="products_stock_qty_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <input type="hidden"
                                                            class="free-stock-qty_vl_<?php echo e($key + 1); ?> form-control text-center"
                                                            name="products[<?php echo e($key + 1); ?>][free_stock_qty]"
                                                            value="<?php echo e($sale_product->pivot->free_qty); ?>"
                                                            id="products_free_stock_qty_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <input type="hidden" class="sale-unit_vl_<?php echo e($key + 1); ?>"
                                                            name="products[<?php echo e($key + 1); ?>][unit]"
                                                            value="<?php echo e($unit_name); ?>"
                                                            id="sale_unit_vl_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <input type="hidden"
                                                            class="sale-unit-operator_vl_<?php echo e($key + 1); ?>"
                                                            value="<?php echo e($unit_operator); ?>"
                                                            id="sale_unit_operator_vl_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <input type="hidden"
                                                            class="sale-unit-operation-value_vl_<?php echo e($key + 1); ?>"
                                                            value="<?php echo e($unit_operation_value); ?>"
                                                            id="sale_unit_operation_value_vl_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <input type="hidden" class="tax-rate"
                                                            name="products[<?php echo e($key + 1); ?>][tax_rate]"
                                                            value="<?php echo e($sale_product->pivot->tax_rate); ?>"
                                                            id="tax_rate_vl_<?php echo e($key + 1); ?>"
                                                            data-row="<?php echo e($key + 1); ?>">
                                                        <?php if($tax): ?>
                                                            <input type="hidden" class="tax-name"
                                                                value="<?php echo e($tax->name); ?>"
                                                                id="tax_name_vl_<?php echo e($key + 1); ?>"
                                                                data-row="<?php echo e($key + 1); ?>">
                                                        <?php else: ?>
                                    ...
                                    <table class="table table-bordered">
                                        <thead class="bg-primary">
                                            <th><strong>Items</strong><span class="float-right"
                                                    id="item"><?php echo e($sale->item); ?>(<?php echo e($sale->total_qty); ?>)</span>
                                            </th>
                                            <th><strong>Total</strong><span class="float-right"
                                                    id="subtotal"><?php echo e($sale->total); ?></span></th>
                                            <th><strong>Order Tax</strong><span class="float-right"
                                                    id="order_total_tax"><?php echo e($sale->order_tax); ?></span></th>
                                            <th><strong>Order Discount</strong><span class="float-right"
                                                    id="order_total_discount"><?php echo e($sale->order_discount); ?></span></th>
                                            <th><strong>Shipping Cost</strong><span class="float-right"
                                                    id="shipping_total_cost"><?php echo e($sale->shipping_cost); ?></span></th>
                                            <th><strong>Labor Cost</strong><span class="float-right"
                                                    id="labor_total_cost"><?php echo e($sale->labor_cost); ?></span></th>
                                            <th><strong>Grand Total</strong><span class="float-right"
                                                    id="grand_total"><?php echo e($sale->grand_total); ?></span></th>
                                        </thead>
                                    </table>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="total_commission" id="total_commission"
                                        value="<?php echo e($sale->total_commission); ?>">
                                </div>
                                <div class="payment col-md-12 <?php if($sale->payment_status == 3): ?> d-none <?php endif; ?>">
                                    <div class="row">
                                        <div class="form-group col-md-4 required">
                                            ...
                                            <input type="text" class="form-control" name="previous_due"
                                                id="previous_due" value="<?php echo e($sale->previous_due); ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-4 required">
                                            <label for="net_total">Net Total</label>
                                            <input type="text" class="form-control" name="net_total" id="net_total"
                                                value="<?php echo e($sale->grand_total + $sale->previous_due); ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-4 required">
                                            <label for="paid_amount">Paid Amount</label>
                                            <input type="text" class="form-control" name="paid_amount"
                                                id="paid_amount" value="<?php echo e($sale->paid_amount); ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="due_amount">Due Amount</label>
                                            <input type="text" class="form-control" name="due_amount" id="due_amount"
                                                value="<?php echo e($sale->due_amount); ?>" readonly>
                                        </div>
                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php $component->withAttributes(['labelName' => 'Payment Method','name' => 'payment_method','onchange' => 'account_list(this.value)','required' => 'required','col' => 'col-md-4']); ?>
                                            <?php $__currentLoopData = SALE_PAYMENT_METHOD; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>"
                                                    <?php if($sale->payment_method): ?> <?php echo e($sale->payment_method == $key ? 'selected' : ''); ?> <?php endif; ?>>
...
<?php endif; ?>
                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Account','name' => 'account_id','required' => 'required','col' => 'col-md-4']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Account','name' => 'account_id','required' => 'required','col' => 'col-md-4']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                                        <div
                                            class="form-group required col-md-4 <?php if($sale->payment_method): ?> <?php echo e($sale->payment_method != 1 ? '' : 'd-none'); ?> <?php endif; ?> reference_no">
                                            <label for="reference_no">Reference No</label>
                                            <input type="text" class="form-control" name="reference_no"
                                                id="reference_no" value="<?php echo e($sale->reference_no); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-md-12 text-center pt-5">
                                    <a href="<?php echo e(url('sale')); ?>" class="btn btn-danger btn-sm mr-3"><i
                                            class="far fa-window-close"></i> Cancel</a>
                                    <button type="button" class="btn btn-primary btn-sm mr-3" id="save-btn"
                                        onclick="update_data()"><i class="fas fa-save"></i> Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            for (rowindex = 0; rowindex <= rownumber; rowindex++) {
                ...
                var quantity = parseFloat($('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.qty').val());
                var free_quantity = parseFloat($('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.free_qty').val());
                product_qty.push(parseFloat($('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.stock-qty_vl_' + (rowindex + 1)).val()));
                product_free_qty.push(parseFloat($('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')')
                    .find('.free-stock-qty_vl_' + (rowindex + 1)).val()));
                ...
                tax_method.push($('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.tax-method')
                    .val());
                temp_unit_name = $('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.sale-unit_vl_' + (rowindex + 1)).val().split(',');
                unit_name.push($('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.sale-unit_vl_' + (rowindex + 1)).val());
                unit_operator.push($('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.sale-unit-operator_vl_' + (rowindex + 1)).val());
                unit_operation_value.push($('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find(
                    '.sale-unit-operation-value_vl_' + (rowindex + 1)).val());
                $('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.sale-unit_vl_' + (rowindex +
                    1)).val(temp_unit_name[0]);
                $('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.unit-name_vl_' + (rowindex +
                    1)).text(temp_unit_name[0]);
                $('#product_table tbody tr:nth-child(' + (rowindex + 1) + ')').find('.unit-name_tx_' + (rowindex +
                    1)).text(temp_unit_name[0]);
            }
        ...
        function update_data() {
            ...
            if (rownumber < 0) {
                ...
                let url = "<?php echo e(route('dealer.sale.update')); ?>";
                $.ajax({
                    url: url,
                    type: "POST",
                    data: formData,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/DealerSale\Resources/views/edit.blade.php ENDPATH**/ ?>