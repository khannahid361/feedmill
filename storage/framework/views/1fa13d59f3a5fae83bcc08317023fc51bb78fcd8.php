                                            ...
                                            <div class="col-sm-12">
                                                <div class="row">
                                                    <div class="col-md-6 form-group required">
                                                        ...
                                                        <input type="hidden" class="form-control"  name="employee_id" id="employee_id" readonly value="<?php echo e($employee->id); ?>">
                                                        <input type="hidden" class="form-control"  name="joining_month" id="joining_month" readonly value="<?php echo e($employee->joining_month); ?>">
                                                        <label for="title"><?php echo e(__('Employee Name')); ?></label>
                                                        <div class="input-group" >
                                                            <input type="text" class="form-control"   readonly value="<?php echo e($employee->name); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 form-group required">
                                                        <label for="title"><?php echo e(__('Employee ID')); ?></label>
                                                        <div class="input-group" >
                                                            <input type="text" class="form-control"  readonly value="<?php echo e($employee->employee_id); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="row">
                                                            <div class="col-md-12 form-group required">
                                                                ...
                                                                <div class="input-group" >
                                                                    <input type="text" class="form-control" readonly name="gross_salary" id="gross_salary" placeholder="0.00">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 form-group required">
                                                                <label for="title"><?php echo e(__('file.Total Deduction')); ?></label>
                                                                <div class="input-group" >
                                                                    <input type="text" class="form-control" readonly name="total_deduction" id="total_deduction" placeholder="0.00">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 form-group required">
                                                                <label for="title"><?php echo e(__('file.Net Payable')); ?></label>
                                                                <div class="input-group" >
                                                                    <input type="text" class="form-control" readonly  name="net_salary" id="net_salary" placeholder="0.00">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function storeData(){
            ...
            let url           = "<?php echo e(route('salary.store.or.update')); ?>";
            $.ajax({
                url           : url,
                type          : "POST",
                data          : formData,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/salary/create.blade.php ENDPATH**/ ?>