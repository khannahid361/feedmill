        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <?php if(permission('district-add')): ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'District Name','name' => 'district_name','col' => 'col-md-4']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'District Name','name' => 'district_name','col' => 'col-md-4']); ?>
                        ...
                        <div class="col-sm-12">
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        <?php if(permission('district-bulk-delete')): ?>
                                        <th>
...
<?php echo $__env->make('location::district.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).ready(function(){
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url" : "<?php echo e(route('district.datatable.data')); ?>",
                "type": "POST",
                "data": function (data) {
            ...
            "buttons": [
                <?php if(permission('district-report')): ?>
                {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "<?php echo e(route('district.store.or.update')); ?>";
        ...
        $(document).on('click', '.edit_data', function () {
            ...
            if (id) {
                $.ajax({
                    url: "<?php echo e(route('district.edit')); ?>",
                    type: "POST",
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "<?php echo e(route('district.delete')); ?>";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "<?php echo e(route('district.bulk.delete')); ?>";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "<?php echo e(route('district.change.status')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Location\Resources/views/district/index.blade.php ENDPATH**/ ?>