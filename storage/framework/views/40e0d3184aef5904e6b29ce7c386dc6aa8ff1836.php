        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <?php if(permission('leave-application-add')): ?>
                    <a href="<?php echo e(route('leave.application.add')); ?>" class="btn btn-primary btn-sm font-weight-bolder">
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Leave Type','name' => 'leave_id','required' => 'required','col' => 'col-md-3','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Leave Type','name' => 'leave_id','required' => 'required','col' => 'col-md-3','class' => 'selectpicker']); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Submission','name' => 'submission','col' => 'col-md-3','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Submission','name' => 'submission','col' => 'col-md-3','class' => 'selectpicker']); ?>
                        ...
                        <div class="col-sm-12">
                                <table id="dataTable" class="table table-bordered table-hover">
                                    <thead class="bg-primary">
                                        <tr>
                                            <?php if(permission('leave-application-bulk-delete')): ?>
                                            <th>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo e(route('leave.application.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            <?php if(permission('leave-application-report')): ?>
            {
    ...
    $(document).on('click', '.delete_data', function () {
            ...
            let url   = "<?php echo e(route('leave.application.delete')); ?>";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "<?php echo e(route('leave.application.bulk.delete')); ?>";
    ...
    $(document).on('click', '.change_status', function () {
        ...
        let row    = table.row($(this).parent('tr'));
        let url    = "<?php echo e(route('leave.application.change.status')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/leave-application/index.blade.php ENDPATH**/ ?>