...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'No. of Barcode','name' => 'barcode_qty','required' => 'required','col' => 'col-md-2','class' => 'text-center','value' => '1','placeholder' => 'Enter barcode print quantity']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'No. of Barcode','name' => 'barcode_qty','required' => 'required','col' => 'col-md-2','class' => 'text-center','value' => '1','placeholder' => 'Enter barcode print quantity']); ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Qunatity Each Row ','name' => 'row_qty','required' => 'required','col' => 'col-md-2','class' => 'text-center','value' => '1','placeholder' => 'Enter barcode print quantity']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Qunatity Each Row ','name' => 'row_qty','required' => 'required','col' => 'col-md-2','class' => 'text-center','value' => '1','placeholder' => 'Enter barcode print quantity']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
$(document).ready(function () {
    $('#product_code_name').autocomplete({
        source: function( request, response ) {
          // Fetch data
          $.ajax({
            url:"<?php echo e(url('barcode/product-autocomplete-search')); ?>",
            type: 'post',
            dataType: "json",
            data: {
               _token: _token,
    ...
    $(document).on('click','#generate-barcode',function(){
        ...
        $.ajax({
            url: "<?php echo e(route('generate.barcode')); ?>",
            type: "POST",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Product\Resources/views/barcode/index.blade.php ENDPATH**/ ?>