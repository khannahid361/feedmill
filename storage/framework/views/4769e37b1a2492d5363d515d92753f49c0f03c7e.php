        ...
        <div class="container-fluid">
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar"><a href="<?php echo e(route('sale')); ?>" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i><?php echo e('Back'); ?></a></div>
                </div>
            </div>
            <div class="card card-custom" style="padding-bottom: 100px !important;">
                <div class="card-body">
                    <form id="store_form" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" id="sale_id" name="sale_id" value="<?php echo e($details->id); ?>"/>
                        <div class="row">
                            <div class="form-group col-md-6 required">
                                <label for="customer"><?php echo e('Customer'); ?></label>
                                <input type="text" class="form-control" value="<?php echo e($details->customer->name); ?>"/>
                                <input type="hidden" id="customer_id" name="customer_id" value="<?php echo e($details->customer->id); ?>"/>
                            </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).on('change','#warehouse_id',function(){
            ...
            if(warehouseId != ''){
                $.ajax({
                    url     : "<?php echo e(route('sale.product.delivery.available.list')); ?>",
        ...
        function storeData(){
            ...
            let url      = "<?php echo e(route('sale.product.delivery.store')); ?>";
            let delivery = 0;
            $('.delivery').each(function() {
                if($(this).val() == ''){
                    delivery += + 0;
            ...
            if(delivery > 0){
                $.ajax({
                    ...
                    success     : function (data) {
                        ...
                        if (data.status == 'success') { window.location.replace("<?php echo e(route('sale')); ?>"); }
                    },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Sale\Resources/views/delivery.blade.php ENDPATH**/ ?>