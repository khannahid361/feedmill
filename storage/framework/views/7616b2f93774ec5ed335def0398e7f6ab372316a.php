        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <!--begin::Button-->
                    <?php if(permission('mobile-bank-access')): ?>
                    <a href="<?php echo e(route('mobilebank')); ?>" class="btn btn-primary btn-sm font-weight-bolder ml-3"> 
                        <i class="fas fa-university"></i> Manage Mobile Bank</a>
                    <?php endif; ?>
                    <?php if(permission('mobile-bank-transaction-access')): ?>
                    <a href="<?php echo e(route('mobilebank.transaction')); ?>" class="btn btn-primary btn-sm font-weight-bolder ml-3"> 
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Mobile Bank Name','name' => 'bank_name','required' => 'required','col' => 'col-md-3','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Mobile Bank Name','name' => 'bank_name','required' => 'required','col' => 'col-md-3','class' => 'selectpicker']); ?>
...
$(document).ready(function(){
    ...
    $(document).on('click','#btn-filter',function(){
        ...
        {
            $.ajax({
                url: "<?php echo e(route('mobilebank.ledger.data')); ?>",
                type: "POST",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/MobileBank\Resources/views/ledger.blade.php ENDPATH**/ ?>