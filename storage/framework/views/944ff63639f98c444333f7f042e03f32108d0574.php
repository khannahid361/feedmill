            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <?php if(permission('material-add')): ?>
                            <a href="javascript:void(0);" onclick="showNewFormModal('Add New Material','Save')"
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Material Name','name' => 'material_name','col' => 'col-md-3']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Material Name','name' => 'material_name','col' => 'col-md-3']); ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Material Code','name' => 'material_code','col' => 'col-md-3']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Material Code','name' => 'material_code','col' => 'col-md-3']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                            ...
                            <div class="col-sm-12">
                                <table id="dataTable" class="table table-bordered table-hover">
                                    <thead class="bg-primary">
                                        <tr>
                                            <?php if(permission('material-bulk-delete')): ?>
                                                <th>
    ...
    <?php echo $__env->make('material::modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('material::view-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('material.datatable.data')); ?>",
                    "type": "POST",
                    "data": function(data) {
                ...
                "buttons": [
                    <?php if(permission('material-report')): ?>
                        {
                            'extend': 'colvis',
            ...
            $(document).on('click', '#save-btn', function() {
                ...
                let url = "<?php echo e(route('material.store.or.update')); ?>";
            ...
            $(document).on('click', '.edit_data', function() {
                ...
                if (id) {
                    $.ajax({
                        url: "<?php echo e(route('material.edit')); ?>",
                        type: "POST",
                        data: {
                            id: id,
                            _token: _token
                        ...
                        success: function(data) {
                            if (data.status == 'error') {
                                ...
                                $('#store_or_update_form #material_name').val(data
                                    .material_name);
                                ...
                                $('#store_or_update_form #cost').val(parseFloat(data.cost)
                                    .toFixed(2));
                                $('#store_or_update_form #unit_id').val(data.unit_id);
                                $('#store_or_update_form #alert_qty').val(data.alert_qty);
                                data.tax_id ? $('#store_or_update_form #tax_id').val(data
                                    .tax_id) : $('#store_or_update_form #tax_id').val(0)
                                ...
                                if (data.has_opening_stock == 1) {
                                    ...
                                    $('.material-qty,.material-cost,.opening-warehouse-id')
                                        .removeClass('d-none');
                                    $('#store_or_update_form #opening_stock_qty').val(data
                                        .opening_stock_qty);
                                    $('#store_or_update_form #opening_cost').val(data
                                        .opening_cost);
                                    $('#store_or_update_form #opening_warehouse_id').val(data
                                        .opening_warehouse_id);
                                } else {
                                    $('#opening_stock').prop('checked', false);
                                    $('#opening_stock_qty,#opening_cost,#opening_warehouse_id')
                                        .val('');
                                    $('.material-qty,.material-cost,.opening-warehouse-id')
                                        .addClass('d-none');
                                }
                                ...
                                $('#store_or_update_modal .modal-title').html(
                                    '<i class="fas fa-edit text-white"></i> <span>Edit ' +
                                    data.name + '</span>');
            ...
            $(document).on('click', '.view_data', function() {
                ...
                if (id) {
                    $.ajax({
                        url: "<?php echo e(route('material.view')); ?>",
                        type: "POST",
                        data: {
                            id: id,
                            _token: _token
                        ...
                        success: function(data) {
                            ...
                            $('#view_modal .modal-title').html(
                                '<i class="fas fa-eye text-white"></i> <span> ' + name +
                                ' Details</span>');
                        },
                        error: function(xhr, ajaxOption, thrownError) {
                            console.log(thrownError + '\r\n' + xhr.statusText + '\r\n' + xhr
            ...
            $(document).on('click', '.delete_data', function() {
                ...
                let url = "<?php echo e(route('material.delete')); ?>";
            ...
            function multi_delete() {
                ...
                if (ids.length == 0) {
                    ...
                    let url = "<?php echo e(route('material.bulk.delete')); ?>";
            ...
            $(document).on('click', '.change_status', function() {
                ...
                let row = table.row($(this).parent('tr'));
                let url = "<?php echo e(route('material.change.status')); ?>";
            ...
            $(document).on('click', '#generate-code', function() {
                $.ajax({
                    url: "<?php echo e(route('material.generate.code')); ?>",
                    type: "GET",
                    dataType: "JSON",
                    beforeSend: function() {
                    ...
                    success: function(data) {
                        data ? $('#store_or_update_form #material_code').val(data) : $(
                            '#store_or_update_form #material_code').val('');
                    },
                    error: function(xhr, ajaxOption, thrownError) {
                        console.log(thrownError + '\r\n' + xhr.statusText + '\r\n' + xhr
                            .responseText);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        if (key == purchase_unit_id) {
                            $('#purchase_unit_id').append('<option value="' + key + '">' + value +
                                '</option>');
                        }
                    });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Material\Resources/views/index.blade.php ENDPATH**/ ?>