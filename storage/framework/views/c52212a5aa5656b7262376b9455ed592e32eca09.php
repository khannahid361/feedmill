...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo e(route('voucher.approval.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            <?php if(permission('voucher-approval-report')): ?>
            {
    ...
    $(document).on('click', '.approve_voucher', function () {
        ...
        let row    = table.row($(this).parent('tr'));
        let url    = "<?php echo e(route('voucher.approval.approve')); ?>";
        Swal.fire({
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Account\Resources/views/voucher-approval/index.blade.php ENDPATH**/ ?>