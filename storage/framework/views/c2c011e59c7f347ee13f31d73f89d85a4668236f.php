            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="customer_id"><?php echo e('Customer'); ?></label>
...
$(document).ready(function(){
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo e(route('collection.report.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $(api.column(5).footer()).html('= '+number_format(total));
        }
    });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Report\Resources/views/collection-report.blade.php ENDPATH**/ ?>