        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <?php if(permission('permission-access')): ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Permission Name','name' => 'name','col' => 'col-md-4']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Permission Name','name' => 'name','col' => 'col-md-4']); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Module','name' => 'module_id','required' => 'required','col' => 'col-md-4','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Module','name' => 'module_id','required' => 'required','col' => 'col-md-4','class' => 'selectpicker']); ?>
                        ...
                        <div class="col-sm-12">
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        <?php if(permission('permission-bulk-delete')): ?>
                                        <th>
...
<?php echo $__env->make('permission.create-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('permission.edit-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo e(route('menu.module.permission.datatable.data')); ?>",
            "type": "POST",
            "data": function (data) {
        ...
        "buttons": [
            <?php if(permission('permission-report')): ?>
            {
    ...
    $(document).on('click', '#save-btn', function () {
        ...
        let url = "<?php echo e(route('menu.module.permission.store')); ?>";
    ...
    $(document).on('click', '.edit_data', function () {
        ...
        if (id) {
            $.ajax({
                url: "<?php echo e(route('menu.module.permission.edit')); ?>",
                type: "POST",
    ...
    $(document).on('click', '#update-btn', function () {
        ...
        let formData = new FormData(form);
        let url = "<?php echo e(route('menu.module.permission.update')); ?>";
        let id = $('#update_id').val();
        let method = 'update';
        $.ajax({
            url: url,
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "<?php echo e(route('menu.module.permission.delete')); ?>";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "<?php echo e(route('menu.module.permission.bulk.delete')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\feedmill\resources\views/permission/index.blade.php ENDPATH**/ ?>