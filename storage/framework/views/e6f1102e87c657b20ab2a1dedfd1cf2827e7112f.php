    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.change_status', function() {
                ...
                $('#approve_status_form #warehouse_id').val($(this).data('warehouseid'));
            ...
            $(document).on('click', '#status-btn', function() {
                ...
                var warehouse_id = $('#approve_status_form #warehouse_id').val();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\laragon\www\insaf\Modules/Production\Resources/views/production/index.blade.php ENDPATH**/ ?>