...
<?php endif; ?>
                                    <?php endif; ?>
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Dealer Area','name' => 'area','value' => ''.e(isset($dealer) ? $dealer->area : '').'','col' => 'col-md-4','placeholder' => 'Enter dealer area']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Dealer Area','name' => 'area','value' => ''.e(isset($dealer) ? $dealer->area : '').'','col' => 'col-md-4','placeholder' => 'Enter dealer area']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                                            ...
                                            <?php if(isset($dealer) && !$dealer->hasManyProducts->isEmpty()): ?>
                                                <?php $__currentLoopData = $dealer->hasManyProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="products[<?php echo e($key+1); ?>][commission_percentage]" value="<?php echo e($item->product->base_unit_price > 0 ? number_format($item->commission_rate * 100/$item->product->base_unit_price,2,'.',',') : 0); ?>" class="form-control text-center " id="products_<?php echo e($key+1); ?>_commission_percentage" onkeyup="generateCommissionRate(<?php echo e($key+1); ?>)">
                                                        </td>
