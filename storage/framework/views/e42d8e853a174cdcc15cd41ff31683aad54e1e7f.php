            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <a href="<?php echo e(route('sr.salary')); ?>" class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-left"></i> SR Salary </a>
                    </div>
                </div>
            </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function srSalaryStore(){
            ...
            let url      = "<?php echo e(route('sr.salary.store')); ?>";
            $.ajax({
                url           : url,
                type          : "POST",
                data          : formData,
                ...
                success       : function (data) {
                    ...
                    if (data.status == false) {
                        ...
                        if (data.status == 'success') { window.location.replace("<?php echo e(route('sr.salary')); ?>"); }
                    }
                },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Salary\Resources/views/srSalary/create.blade.php ENDPATH**/ ?>