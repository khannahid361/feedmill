                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control daterangepicker-filed" value="<?php echo e(date('Y-m-').'-01'); ?> To <?php echo e(date('Y-m-d')); ?>">
                                <input type="hidden" id="start_date" name="start_date" value="<?php echo e(date('Y-m-').'-01'); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Customer\Resources/views/ledger/index.blade.php ENDPATH**/ ?>