                ...
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <?php if(permission('supplier-payment-access')): ?>
                            <a href="<?php echo e(route('dealer.yearly.commission.payment')); ?>"  class="btn btn-warning btn-sm font-weight-bolder"><i class="fas fa-arrow-circle-left"></i> Back</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Dealer','name' => 'dealer_id','onchange' => 'dueAmount(this.value)','required' => 'required','col' => 'col-md-3','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Dealer','name' => 'dealer_id','onchange' => 'dueAmount(this.value)','required' => 'required','col' => 'col-md-3','class' => 'selectpicker']); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        function dueAmount(dealer_id) {
            $.ajax({
                url: "<?php echo e(url('dealer-yearly-commission-due')); ?>/"+dealer_id,
                type: "GET",
                dataType: "JSON",
                success: function (data) {
        ...
        function store_data(){
            ...
            let url = "<?php echo e(route('dealer.yearly.commission.payment.store')); ?>";
            $.ajax({
                url        : url,
                type       : "POST",
                data       : formData,
                ...
                success    : function (data) {
                    ...
                    if (data.status == false) {
                        ...
                        window.location.replace("<?php echo e(url('dealer-yearly-commission-payment')); ?>");
                    }
                },
                error: function (xhr, ajaxOption, thrownError) {console.log(thrownError + '\r\n' + xhr.statusText + '\r\n' + xhr.responseText);}
            });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Account\Resources/views/yearly-commission-payment/create.blade.php ENDPATH**/ ?>