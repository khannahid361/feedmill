<?php if($ledger_data): ?>
<?php $__currentLoopData = $ledger_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        ...
        <td class="text-right font-weight-bolder" style="color:#002447 !important;"><?php echo e($value['previous_cost']); ?></td>
        <td class="text-right font-weight-bolder" style="color:#002447 !important;"><?php echo e($value['previous_value']); ?></td>
        <?php endif; ?>
        ...
        <td class="text-right font-weight-bolder" style="color:#1F9F04 !important;"><?php echo e($value['purchase_qty']); ?></td>
        <?php if(permission('material-stock-ledger-cost-view')): ?>
        <td class="text-right font-weight-bolder" style="color:#1F9F04 !important;"><?php echo e($value['purchase_cost']); ?></td>
        <td class="text-right font-weight-bolder" style="color:#1F9F04 !important;"><?php echo e($value['purchase_value']); ?></td>
        <?php endif; ?>
        <td class="text-center">
            <ul  style="list-style:none;margin:0;padding:0;">
        ...
        <td class="text-right">
            <ul style="list-style:none;margin:0;padding:0;">
                <li class="text-center px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_qty']['production_material_qty']); ?></li>
                <li class="text-center px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_qty']['returned_material_qty']); ?></li>
                <li class="text-center px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_qty']['damage_material_qty']); ?></li>
            </ul>
        </td>
        <?php if(permission('material-stock-ledger-cost-view')): ?>
        <td class="text-right">
            <ul style="list-style:none;margin:0;padding:0;">
                <li class="text-right px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_cost']['production_material_cost']); ?></li>
                <li class="text-right px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_cost']['returned_material_cost']); ?></li>
                <li class="text-right px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_cost']['damage_material_cost']); ?></li>
            </ul>
        </td>
        <td class="text-right">
            <ul style="list-style:none;margin:0;padding:0;">
                <li class="text-right px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_subtotal']['production_material_cost']); ?></li>
                <li class="text-right px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_subtotal']['returned_material_cost']); ?></li>
                <li class="text-right px-2 font-weight-bolder" style="color: darkred;"><?php echo e($value['production_subtotal']['damage_material_cost']); ?></li>
            </ul>
        </td>
...
<?php endif; ?><?php /**PATH C:\laragon\www\insaf\Modules/StockLedger\Resources/views/material-ledger/data.blade.php ENDPATH**/ ?>