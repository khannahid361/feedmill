...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.textbox','data' => ['labelName' => 'Holiday Name','name' => 'name','col' => 'col-md-4']]); ?>
<?php $component->withName('form.textbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Holiday Name','name' => 'name','col' => 'col-md-4']); ?>
                        ...
                        <div class="col-sm-12">
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        <?php if(permission('holiday-bulk-delete')): ?>
                                        <th>
...
<?php echo $__env->make('hrm::holiday.modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo e(route('holiday.datatable.data')); ?>",
                "type": "POST",
                "data": function (data) {
            ...
            "buttons": [
                <?php if(permission('holiday-report')): ?>
                {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "<?php echo e(route('holiday.store.or.update')); ?>";
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "<?php echo e(route('holiday.delete')); ?>";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "<?php echo e(route('holiday.bulk.delete')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/holiday/index.blade.php ENDPATH**/ ?>