...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-5">
                    ...
                    <div class="card-toolbar">
                        <?php if(permission('contra-voucher-add')): ?>
                            <a href="<?php echo e(route('contra.voucher.create')); ?>"  class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> Add New</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    <?php echo $__env->make('account::contra-voucher.view-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            table = $('#dataTable').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('contra.voucher.datatable.data')); ?>",
                    "type": "POST",
                    "data": function (data) {
            ...
            $(document).on('click', '.delete_data', function () {
                ...
                let url   = "<?php echo e(route('voucher.approval.delete')); ?>";
            ...
            $(document).on('click', '.view_data', function () {
                ...
                if (id) {
                    $.ajax({
                        url: "<?php echo e(route('contra.voucher.view')); ?>",
                        type: "POST",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Account\Resources/views/contra-voucher/list.blade.php ENDPATH**/ ?>