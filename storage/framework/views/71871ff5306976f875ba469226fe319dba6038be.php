...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Material','name' => 'material_id','col' => 'col-md-4','class' => 'selectpicker']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Material','name' => 'material_id','col' => 'col-md-4','class' => 'selectpicker']); ?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#btn-filter').click(function () {
            ...
            {
                $.ajax({
                    url: "<?php echo e(route('material.stock.ledger.data')); ?>",
                    type: "POST",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/StockLedger\Resources/views/material-ledger/index.blade.php ENDPATH**/ ?>