        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <?php if(permission('attendance-add')): ?>
                    <a href="javascript:void(0);" onclick="showFormModal('Add New Attendance','Save')" class="btn btn-primary btn-sm font-weight-bolder"><i class="fas fa-plus-circle"></i> Add New</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "<?php echo e(route('attendance.datatable.data')); ?>",
                "type": "POST",
                "data": function (data) {
            ...
            "columnDefs": [{
                    <?php if(permission('attendance-bulk-delete')): ?>
                    "targets": [0,6],
                    <?php else: ?>
                    "targets": [3],
                    <?php endif; ?>
            ...
            "buttons": [
                <?php if(permission('attendance-report')): ?>
                {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "<?php echo e(route('attendance.store.or.update')); ?>";
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "<?php echo e(route('attendance.delete')); ?>";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "<?php echo e(route('attendance.bulk.delete')); ?>";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "<?php echo e(route('attendance.change.status')); ?>";
    ...
    function getEmployeeDetails(employee_id) {
        $.ajax({
            url: "<?php echo e(url('employee-id-wise-employee-details')); ?>/" + employee_id,
            type: "GET",
            dataType: "JSON",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/HRM\Resources/views/attendance/index.blade.php ENDPATH**/ ?>