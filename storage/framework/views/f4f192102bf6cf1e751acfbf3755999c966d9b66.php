...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.form.selectbox','data' => ['labelName' => 'Dealer','name' => 'dealer_id','col' => 'col-md-3','class' => 'fcs']]); ?>
<?php $component->withName('form.selectbox'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['labelName' => 'Dealer','name' => 'dealer_id','col' => 'col-md-3','class' => 'fcs']); ?>
...
<?php endif; ?>
                                ...
                                <div class="form-group col-md-12 text-center pt-5">
                                    <button type="button" class="btn btn-danger btn-sm mr-3"
                                        onclick="window.location.replace('<?php echo e(route('dealer.sale.add')); ?>');"><i
    ...
    <script>
        ...
        function store_data() {
            ...
            if (rownumber < 0) {
                ...
                let url = "<?php echo e(route('dealer.sale.store')); ?>";
                $.ajax({
                    url: url,
                    type: "POST",
                    data: formData,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/DealerSale\Resources/views/create.blade.php ENDPATH**/ ?>