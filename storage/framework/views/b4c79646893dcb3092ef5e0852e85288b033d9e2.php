        ...
        $(document).on('change','#salesmen_id',function(){
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    $.each(data, function(index, item) { html += '<option value="'+ item['area_id'] +'">'+ item['area_name'] +'</option>'; });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\insaf\Modules/Sale\Resources/views/create.blade.php ENDPATH**/ ?>