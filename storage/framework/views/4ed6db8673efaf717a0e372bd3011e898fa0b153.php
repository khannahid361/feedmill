                                    ...
                                    <?php if(!$warehouses->isEmpty()): ?>
                                        <?php $__currentLoopData = $warehouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warehouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($warehouse->id); ?>"
                                                <?php echo e($warehouse->id == 1 ? 'selected' : ''); ?>><?php echo e($warehouse->name); ?></option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-3 required">
                                                            ...
                                                            <input type="text" class="form-control date total-time"
                                                                ...
                                                                value="<?php echo e(date('Y-m-d')); ?>" onblur="setExpireTime();"
                                                                readonly />
                                                        </div>
                                                        <div class="form-group col-md-3 required">
        ...
        $(document).ready(function() {
            ...
            function add_new_tab(tab) {
                ...
                tab_content_html = `<div class="tab-pane  step step-` + tab + `  p-3" id="tab-` + tab + `" role="tabpanel">
                    ...
                    `_mfg_date" value="<?php echo e(date('Y-m-d')); ?>" readonly />
                                                    </div>
                                                    <div class="form-group col-md-3 required">
                                                        <label for="exp_date">Exp. Date</label>
                                                        <input type="text" class="form-control date" name="production[` +
                    tab + `][exp_date]" id="production_` + tab + `_exp_date" value="<?php echo e(date('Y-m-d', strtotime('+1 year'))); ?>" readonly />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).on('input', '.finishedQty', function() {
            ...
            $('.track').each(function(i, k) {
                ...
                document.getElementById($(this).data('total')).value = $(this).data('qtys') * $(this).data(
                    'cost') * finishedQty;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\insaf\Modules/Production\Resources/views/production/create.blade.php ENDPATH**/ ?>