            ...
            <div class="row">
                <div class="col-md-3 mb-5">
                    <div class="bg-white text-center py-3  rounded-xl">
                        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-3"><img src="{{asset('images/purchase.svg')}}" alt="purchase" class="icon"></span>
                ...
                <div class="col-md-3 mb-5">
                    <div class="bg-white text-center py-3  rounded-xl">
                        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-3"><img src="{{asset('images/sale.svg')}}" alt="sale" class="icon"></span>
                ...
                <div class="col-md-3 mb-5">
                    <div class="bg-white text-center py-3  rounded-xl">
                        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-3"><img src="{{asset('images/income.svg')}}" alt="income" class="icon"></span>
                ...
                <div class="col-md-3 mb-5">
                    <div class="bg-white text-center py-3  rounded-xl">
                        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-3"><img src="{{asset('images/expense.svg')}}" alt="expense" class="icon"></span>
                ...
                <div class="col-md-3 mb-5">
                    <div class="bg-white text-center py-3  rounded-xl">
                        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-3"><img src="{{asset('images/supplier-due.png')}}" alt="supplier" class="icon"></span>
                ...
                <div class="col-md-3 mb-5">
                    <div class="bg-white text-center py-3  rounded-xl">
                        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-3"><img src="{{asset('images/customer-due.png')}}" alt="customer" class="icon"></span>
                ...
                <div class="col-md-3 mb-5">
                    <div class="bg-white text-center py-3  rounded-xl">
                        <span class="svg-icon svg-icon-3x svg-icon-danger d-block my-3"><img src="{{asset('images/customer.png')}}" alt="customer" class="icon"></span>
